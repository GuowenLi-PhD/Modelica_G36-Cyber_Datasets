...
package template "Modelica template for overwrting signals"
  ...
  model BaselineSystem "System example for fault injection"
    ...
    FaultInjection.Utilities.Overwrite.OverwriteParameter oveTCooOn(
      ...
      unit="K",
      p=297.15,
      description= "Zone temperature setpoint during cooling on")
      "Overwrite parameter TCooOn"
      annotation (Placement(transformation(extent={{58,334},{78,354}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveOnChi(
      u(unit="1",min=0,max=1),
      description="Chiller on signal") "Overwrite chiller on/off signal"
      annotation (Placement(transformation(extent={{1326,-118},{1346,-98}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveOnSupFan(u(
        unit="1",
        min=0,
        max=1), description="Supply air fan speed")
      annotation (Placement(transformation(extent={{480,630},{500,650}})));
    Buildings.Utilities.Psychrometrics.TWetBul_TDryBulPhi wetBul
      annotation (Placement(transformation(extent={{-212,140},{-192,160}})));
    Modelica.Blocks.Routing.RealPassThrough RHOut(y(
        final unit="1",
        displayUnit="1",
        min=0)) "Relative humidity out"
      annotation (Placement(transformation(extent={{-300,110},{-280,130}})));
    Modelica.Blocks.Routing.RealPassThrough amtOut(y(
        quantity="Pressure",
        final unit="Pa",
        displayUnit="Pa",
        min=0)) "Ambient pressure"
      annotation (Placement(transformation(extent={{-300,80},{-280,100}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveRelHumOutAir(
        description="Outdoor air relative humidity", u(
        unit="1",
        min=0,
        max=1)) "Overwrite outdoor air relative humidity"
      annotation (Placement(transformation(extent={{-252,110},{-232,130}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveValCooCoi(
        description="Cooling coil valve position", u(
        unit="1",
        min=0,
        max=1)) "Overwrite cooling coil valve position"
      annotation (Placement(transformation(extent={{500,-150},{520,-130}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveValHeaCoi(
        description="Heating coil valve position", u(
        unit="1",
        min=0,
        max=1)) "Overwrite heating coil valve position"
      annotation (Placement(transformation(extent={{78,-166},{98,-146}})));
    Modelica.Blocks.Math.IntegerToReal int2ReaPZonResReq
      annotation (Placement(transformation(extent={{340,330},{360,350}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable ovePZonResReq(u(
        unit="1",
        min=0,
        max=15), description="Zone pressure reset request numbers")
      annotation (Placement(transformation(extent={{368,330},{388,350}})));
    Modelica.Blocks.Math.RealToInteger rea2IntPZonResReq
      annotation (Placement(transformation(extent={{398,330},{418,350}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveOnChiWatPum(
        description="chilled water pump on", u(
        unit="1",
        min=0,
        max=1)) "Overwrite chilled water pump on/off signal"
      annotation (Placement(transformation(extent={{1360,-200},{1380,-180}})));
    Buildings.Controls.OBC.CDL.Continuous.Product proCooTow
      annotation (Placement(transformation(extent={{1400,-90},{1420,-70}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveOnCooTow(u(
        unit="1",
        min=0,
        max=1), description="Cooling tower on signal")
      "Overwrite cooling tower on/off signal"
      annotation (Placement(transformation(extent={{1360,-80},{1380,-60}})));
    ...
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveOnBoi(u(
        unit="1",
        min=0,
        max=1), description="Boiler on signal") "Overwrite boiler on/off signal"
      annotation (Placement(transformation(extent={{0,-220},{20,-200}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveOnHotWatPum(u(
        unit="1",
        min=0,
        max=1), description="Hot water pump on signal")
      "Overwrite boiler pump on/off signal"
      annotation (Placement(transformation(extent={{-40,-220},{-20,-200}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveTZon1(
      u(unit="K",
        min=273.15 + 5,
        max=273.15 + 35),
      description="Zone 1 temperatures")
      "Overwrite zone 1 temperature"
      annotation (Placement(transformation(extent={{1120,620},{1140,640}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveTZon2(
      u(unit="K",
        min=273.15 + 5,
        max=273.15 + 35),
      description="Zone 2 temperatures")
      "Overwrite zone 2 temperature"
      annotation (Placement(transformation(extent={{1120,590},{1140,610}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveTZon3(
      u(unit="K",
        min=273.15 + 5,
        max=273.15 + 35),
      description="Zone 3 temperatures")
      "Overwrite zone 3 temperature"
      annotation (Placement(transformation(extent={{1120,560},{1140,580}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveTZon4(
      u(unit="K",
        min=273.15 + 5,
        max=273.15 + 35),
     description="Zone 4 temperatures")
      "Overwrite zone 4 temperature"
      annotation (Placement(transformation(extent={{1120,532},{1140,552}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveTZon5(
      u(unit="K",
        min=273.15 + 5,
        max=273.15 + 35),
     description="Zone 5 temperatures")
      "Overwrite zone 5 temperature"
      annotation (Placement(transformation(extent={{1120,500},{1140,520}})));
    Modelica.Blocks.Routing.Multiplex5 TRooAtt
      annotation (Placement(transformation(extent={{1162,570},{1182,590}})));
    Modelica.Blocks.Math.IntegerToReal int2ReaOpeMod
      annotation (Placement(transformation(extent={{48,260},{68,280}})));
    FaultInjection.Utilities.Overwrite.OverwriteVariable oveOpeMod(u(
        unit="1",
        min=1,
        max=7), description="AHU operation mode")
      annotation (Placement(transformation(extent={{76,260},{96,280}})));
    Modelica.Blocks.Math.RealToInteger rea2IntOpeMod
      annotation (Placement(transformation(extent={{106,260},{126,280}})));
    Modelica.Blocks.Math.Product pro
      annotation (Placement(transformation(extent={{500,600},{520,620}})));
    Modelica.Blocks.Math.BooleanToReal fanOnRea
      annotation (Placement(transformation(extent={{450,630},{470,650}})));
  equation
    ...
    connect(temDifPreRes.TSet, cooModCon.TCHWSupSet) annotation (Line(points={{1217,
            ...
            1018,-250.222},{1026,-250.222}},
                                      color={0,0,127}));
    connect(TOut.y, chiPlaEnaDis.TOut) annotation (Line(points={{-279,180},{
            1078,180},{1078,-105.4},{1098,-105.4}},
                                           color={255,0,0},
        thickness=0.5));
    ...
    connect(heaCoi.port_b1, HWVal.port_a)
      annotation (Line(points={{98,-52},{98,-170},{98,-170}},color={255,85,170},
        thickness=0.5));
    ...
    connect(THWSup.port_a, heaCoi.port_a1) annotation (Line(points={{350,-214},{350,
            -140},{142,-140},{142,-52},{118,-52}},     color={255,85,170},
        thickness=0.5));
    connect(wseOn.y, chiWSE.on[2]) annotation (Line(points={{1347,-154},{1408,-154},
            {1408,-338},{866,-338},{866,-215.6},{695.6,-215.6}},
                                                              color={255,0,255}));
    connect(boiPlaEnaDis.yPla, boiTSupCon.trigger) annotation (Line(points={{-257,
            -160},{-238,-160},{-238,-78},{-92,-78},{-92,-292},{-72,-292},{-72,-290}},
          color={255,0,255}));
    ...
    connect(oveTChiWatSupSet.y, chiWSE.TSet) annotation (Line(points={{1221,-300},
            {1240,-300},{1240,-354},{774,-354},{774,-218.8},{695.6,-218.8}},
          color={255,0,0},
        thickness=0.5));
    connect(oveTChiWatSupSet.y, cooTowSpeCon.TCHWSupSet) annotation (Line(points={{1221,
            -300},{1240,-300},{1240,-97.1111},{1284,-97.1111}},        color={255,0,0},
        thickness=0.5));

    connect(chiStaCon.y,oveOnChi. u) annotation (Line(points={{1307,-128},{1314,-128},
            {1314,-108},{1324,-108}}, color={0,0,127}));
    connect(oveOnChi.y, chiOn.u) annotation (Line(points={{1347,-108},{1360,-108},
            {1360,-120},{1316,-120},{1316,-128},{1324,-128}}, color={238,46,47},
        thickness=0.5));

    connect(towTApp.y, cooModCon.TApp) annotation (Line(points={{1009,-290},{
            1018,-290},{1018,-257.111},{1026,-257.111}}, color={0,0,127}));
    connect(weaBus.relHum, RHOut.u) annotation (Line(
        points={{-320,180},{-312,180},{-312,120},{-302,120}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
    ...
    connect(TOut.y, wetBul.TDryBul) annotation (Line(
        points={{-279,180},{-240,180},{-240,158},{-213,158}},
        color={238,46,47},
        thickness=0.5));
    connect(weaBus.pAtm, amtOut.u) annotation (Line(
        points={{-320,180},{-312,180},{-312,90},{-302,90}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(amtOut.y, wetBul.p) annotation (Line(points={{-279,90},{-226,90},{
            -226,142},{-213,142}}, color={0,0,127}));
    connect(wetBul.TWetBul, cooModCon.TWetBul) annotation (Line(points={{-191,
            150},{-186,150},{-186,176},{468,176},{468,-64},{1012,-64},{1012,
            -254},{1024,-254},{1024,-253.778},{1026,-253.778}}, color={238,46,
            47},
        thickness=0.5));
    connect(RHOut.y, oveRelHumOutAir.u)
      annotation (Line(points={{-279,120},{-254,120}}, color={0,0,127}));
    connect(oveRelHumOutAir.y, wetBul.phi) annotation (Line(
        points={{-231,120},{-228,120},{-228,150},{-213,150}},
        color={238,46,47},
        thickness=0.5));
    connect(watVal.y_actual, oveValCooCoi.u) annotation (Line(points={{531,-113},
            {531,-122},{490,-122},{490,-140},{498,-140}}, color={0,0,127}));
    connect(oveValCooCoi.y, plaReqChi.uPlaVal) annotation (Line(
        points={{521,-140},{524,-140},{524,-60},{1026,-60},{1026,-110},{1042,-110}},
        color={255,0,0},
        thickness=0.5));

    connect(oveValCooCoi.y, temDifPreRes.u) annotation (Line(
        points={{521,-140},{524,-140},{524,-60},{1180,-60},{1180,-244},{1194,-244}},
        color={255,0,0},
        thickness=0.5));

    connect(HWVal.y_actual, oveValHeaCoi.u) annotation (Line(points={{91,-185},
            {91,-200},{68,-200},{68,-156},{76,-156}}, color={0,0,127}));
    connect(oveValHeaCoi.y, triResHW.u) annotation (Line(
        points={{99,-156},{106,-156},{106,-62},{-164,-62},{-164,-226},{-158,-226}},
        color={238,46,47},
        thickness=0.5));

    connect(int2ReaPZonResReq.y, ovePZonResReq.u)
      annotation (Line(points={{361,340},{366,340}}, color={0,0,127}));
    connect(ovePZonResReq.y, rea2IntPZonResReq.u)
      annotation (Line(points={{389,340},{396,340}}, color={0,0,127}));
    connect(PZonResReq.y, int2ReaPZonResReq.u)
      annotation (Line(points={{322,340},{338,340}}, color={255,127,0}));
    connect(rea2IntPZonResReq.y, conAHU.uZonPreResReq) annotation (Line(
        points={{419,340},{426,340},{426,484},{326,484},{326,520.889},{336,
            520.889}},
        color={238,46,47},
        thickness=0.5));
    connect(oveOnChiWatPum.y, proCHWP.u1) annotation (Line(
        points={{1381,-190},{1386,-190},{1386,-232},{1368,-232},{1368,-244},{
            1374,-244}},
        color={238,46,47},
        thickness=0.5));
    connect(booToRea.y, oveOnChiWatPum.u) annotation (Line(points={{1189,-116},
            {1234,-116},{1234,-62},{1352,-62},{1352,-190},{1358,-190}}, color={
            0,0,127}));
    connect(cooTowSpeCon.y, proCooTow.u2) annotation (Line(points={{1307,
            -97.1111},{1320,-97.1111},{1320,-86},{1398,-86}},
                                                    color={0,0,127}));
    connect(oveOnCooTow.y, proCooTow.u1) annotation (Line(points={{1381,-70},{1390,
            -70},{1390,-74},{1398,-74}}, color={0,0,127}));
    connect(booToRea.y,oveOnCooTow. u) annotation (Line(points={{1189,-116},{1236,
            -116},{1236,-64},{1350,-64},{1350,-70},{1358,-70}}, color={0,0,127}));
    connect(proCooTow.y, cooTow.y) annotation (Line(points={{1422,-80},{1428,-80},
            {1428,-338},{724,-338},{724,-308},{736,-308}}, color={0,0,127}));
    connect(chiPlaEnaDis.yPla,minFloBypCHW. yPlaBoi) annotation (Line(points={{1121,
            -110},{1142,-110},{1142,-128},{1024,-128},{1024,-153},{1038,-153}},
          color={255,0,255}));
    connect(minFloBypCHW.m_flowHW, chiWSE.mCHW_flow) annotation (Line(points={{1038,
            -147},{1008,-147},{1008,-176},{668,-176},{668,-206},{673,-206}},
          color={0,0,127}));
    connect(booToReaHW.y,oveOnBoi. u) annotation (Line(points={{-197,-160},{-94,-160},
            {-94,-186},{-12,-186},{-12,-210},{-2,-210}}, color={0,0,127}));
    connect(oveOnBoi.y, proBoi.u1) annotation (Line(
        points={{21,-210},{40,-210},{40,-240},{-38,-240},{-38,-266},{-34,-266}},
        color={238,46,47},
        thickness=0.5));
    connect(booToReaHW.y, oveOnHotWatPum.u) annotation (Line(points={{-197,-160},
            {-94,-160},{-94,-186},{-50,-186},{-50,-210},{-42,-210}}, color={0,0,
            127}));
    connect(oveOnHotWatPum.y, proPumHW.u1) annotation (Line(
        points={{-19,-210},{-14,-210},{-14,-238},{-40,-238},{-40,-308},{-34,-308}},
        color={238,46,47},
        thickness=0.5));

    connect(conAHU.yCoo, watVal.y) annotation (Line(points={{424,544},{460,544},{460,
            -108},{526,-108}}, color={0,0,127}));
    connect(chiWSE.TCHWSupWSE, cooModCon.TCHWSupWSE) annotation (Line(points={{673,
            -212},{666,-212},{666,-170},{966,-170},{966,-260.444},{1026,
            -260.444}},
          color={0,0,127}));
    connect(flo.TRooAir[1], oveTZon1.u) annotation (Line(points={{1094.14,488.4},
            {1104,488.4},{1104,630},{1118,630}},color={0,0,127}));
    connect(flo.TRooAir[2], oveTZon2.u) annotation (Line(points={{1094.14,
            489.867},{1106,489.867},{1106,600},{1118,600}},
                                                   color={0,0,127}));
    connect(flo.TRooAir[3], oveTZon3.u) annotation (Line(points={{1094.14,
            491.333},{1108,491.333},{1108,570},{1118,570}},
                                                   color={0,0,127}));
    connect(flo.TRooAir[4], oveTZon4.u) annotation (Line(points={{1094.14,492.8},
            {1110,492.8},{1110,542},{1118,542}},color={0,0,127}));
    connect(flo.TRooAir[5], oveTZon5.u) annotation (Line(points={{1094.14,
            494.267},{1112,494.267},{1112,510},{1118,510}},
                                                   color={0,0,127}));
    connect(oveTZon1.y,TRooAtt. u1[1]) annotation (Line(points={{1141,630},{1150,630},
            {1150,590},{1160,590}}, color={0,0,127}));
    connect(oveTZon2.y,TRooAtt. u2[1]) annotation (Line(points={{1141,600},{1148,600},
            {1148,585},{1160,585}}, color={0,0,127}));
    connect(oveTZon3.y,TRooAtt. u3[1]) annotation (Line(points={{1141,570},{1148,570},
            {1148,580},{1160,580}}, color={0,0,127}));
    connect(oveTZon4.y,TRooAtt. u4[1]) annotation (Line(points={{1141,542},{1150,542},
            {1150,575},{1160,575}}, color={0,0,127}));
    connect(oveTZon5.y,TRooAtt. u5[1]) annotation (Line(points={{1141,510},{1152,510},
            {1152,570},{1160,570}}, color={0,0,127}));
    connect(TRooAtt.y, zonOutAirSet.TZon) annotation (Line(points={{1183,580},{1192,
            580},{1192,656},{212,656},{212,590},{218,590}}, color={0,0,127}));
    connect(TRooAtt.y, TZonSet.TZon) annotation (Line(points={{1183,580},{1192,580},
            {1192,656},{46,656},{46,313},{58,313}}, color={0,0,127}));
    connect(oveTChiWatRet.y, cooModCon.TCHWRetWSE) annotation (Line(points={{635,
            -160},{970,-160},{970,-263.778},{1026,-263.778}},     color={0,0,
            127}));
    connect(TCHWRet.T, oveTChiWatRet.u) annotation (Line(points={{590,-177},{
            590,-160},{612,-160}}, color={0,0,127}));
    connect(TZonSet[1].yOpeMod, int2ReaOpeMod.u) annotation (Line(points={{82,
            303},{88,303},{88,290},{36,290},{36,270},{46,270}}, color={255,127,
            0}));
    connect(int2ReaOpeMod.y, oveOpeMod.u)
      annotation (Line(points={{69,270},{74,270}}, color={0,0,127}));
    connect(oveOpeMod.y, rea2IntOpeMod.u)
      annotation (Line(points={{97,270},{104,270}}, color={0,0,127}));
    connect(rea2IntOpeMod.y, conAHU.uOpeMod) annotation (Line(points={{127,270},
            {134,270},{134,531.556},{336,531.556}}, color={255,127,0}));
    connect(rea2IntOpeMod.y, conVAVCor.uOpeMod) annotation (Line(points={{127,
            270},{134,270},{134,200},{516,200},{516,32},{528,32}}, color={255,
            127,0}));
    connect(rea2IntOpeMod.y, conVAVSou.uOpeMod) annotation (Line(points={{127,
            270},{134,270},{134,200},{682,200},{682,30},{698,30}}, color={255,
            127,0}));
    connect(rea2IntOpeMod.y, conVAVEas.uOpeMod) annotation (Line(points={{127,
            270},{134,270},{134,200},{866,200},{866,30},{878,30}}, color={255,
            127,0}));
    connect(rea2IntOpeMod.y, conVAVNor.uOpeMod) annotation (Line(points={{127,
            270},{134,270},{134,200},{1022,200},{1022,30},{1038,30}}, color={
            255,127,0}));
    connect(rea2IntOpeMod.y, conVAVWes.uOpeMod) annotation (Line(points={{127,
            270},{134,270},{134,200},{1222,200},{1222,28},{1238,28}}, color={
            255,127,0}));
    connect(weaBus.TWetBul, cooTow.TAir) annotation (Line(
        points={{-320,180},{-312,180},{-312,204},{726,204},{726,-312},{736,-312}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
    ...
    connect(conAHU.ySupFan, fanOnRea.u) annotation (Line(points={{424,629.333},
            {436,629.333},{436,640},{448,640}}, color={255,0,255}));
    connect(fanOnRea.y,oveOnSupFan. u)
      annotation (Line(points={{471,640},{478,640}}, color={0,0,127}));
    connect(oveOnSupFan.y, pro.u1) annotation (Line(points={{501,640},{524,640},
            {524,624},{486,624},{486,616},{498,616}}, color={0,0,127}));
    connect(conAHU.ySupFanSpe, pro.u2) annotation (Line(points={{424,618.667},{
            480,618.667},{480,604},{498,604}}, color={0,0,127}));
    connect(pro.y, fanSup.y) annotation (Line(points={{521,610},{526,610},{526,
            456},{456,456},{456,24},{310,24},{310,-28}}, color={0,0,127}));
    annotation (
    ...
    partial model PartialWaterside
     ...
     // WSE parameters
      ...
      Modelica.Blocks.Math.IntegerToBoolean intToBoo(
        threshold=Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.FullMechanical))
      ...
      Modelica.Fluid.Sensors.TemperatureTwoPort  TCHWSup(redeclare replaceable
          package Medium = MediumW)
        "Chilled water supply temperature"
        annotation (Placement(transformation(extent={{778,-138},{758,-118}})));
      Modelica.Fluid.Sensors.TemperatureTwoPort TCWSup(redeclare replaceable
          package Medium = MediumW)
        "Condenser water supply temperature"
        annotation (Placement(transformation(extent={{818,-326},{838,-306}})));
      Modelica.Fluid.Sensors.TemperatureTwoPort  TCWRet(redeclare replaceable
          package Medium = MediumW)
      ...
      Buildings.Fluid.Movers.SpeedControlled_y     pumCW(
        ...
        energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
            ...
            rotation=-90,
            origin={910,-288})));
      Modelica.Fluid.Sensors.TemperatureTwoPort  TCHWRet(
        redeclare replaceable package Medium = MediumW)
        "Chilled water return temperature"
        annotation (Placement(transformation(extent={{600,-198},{580,-178}})));
      ...
      FaultInjection.Utilities.Overwrite.OverwriteVariable oveTChiWatSupSet(u(
          unit="K",
          min=273.15 + 5,
          max=273.15 + 10), description=
            "Chilled water supply temperature setpoint") annotation (Placement(
            transformation(extent={{1200,-310},{1220,-290}})));
      FaultInjection.Utilities.Overwrite.OverwriteVariable oveDifPreChiWatSet(
          description="chilled water differential pressure setpoint", u(
          unit="Pa",
          min=18000,
          max=36000))
        "overwirte chilled water loop differential pressure setpoint"
        annotation (Placement(transformation(extent={{1254,-232},{1274,-212}})));
      FaultInjection.Utilities.Overwrite.OverwriteVariable oveOnConWatPum(
          description="condenser water pump on", u(
          unit="1",
          min=0,
          max=1)) "Overwrite condenser water pump on/off signal" annotation (
          Placement(transformation(extent={{1288,-244},{1308,-224}})));
      FaultInjection.Utilities.Overwrite.OverwriteVariable oveTConWatSupSet(
          description="Condenser water supply temperature setpoint", u(
          unit="K",
          min=273.15 + 15,
          max=273.15 + 30))
        "Overwrite condenser water supply temperature setpoint" annotation (
          Placement(transformation(extent={{1202,-150},{1222,-130}})));
      FaultInjection.Utilities.Overwrite.OverwriteVariable oveTChiWatRet(
          description="Chilled water return temperature", u(
          unit="K",
          min=273.15 + 0.5,
          max=273.15 + 60)) "Overwrite chilled water return temperature"
        annotation (Placement(transformation(extent={{614,-170},{634,-150}})));
    equation
      ...
      connect(senRelPre.port_b, TCHWRet.port_b) annotation (Line(
          points={{558,-140},{538,-140},{538,-188},{580,-188}},
          color={28,108,200},
          thickness=0.5));
      connect(TCWRet.port_a,chiWSE. port_b1) annotation (Line(points={{534,-316},{
              502,-316},{502,-228},{664,-228},{664,-214},{674,-214}},
                                            color={0,0,255},
          thickness=0.5));
      connect(watVal.port_b, TCHWRet.port_b) annotation (Line(
          points={{538,-118},{538,-188},{580,-188}},
          color={28,108,200},
          thickness=0.5));
      connect(expVesChi.ports[1], TCHWRet.port_b) annotation (Line(
          points={{522,-179},{538,-179},{538,-188},{580,-188}},
          color={28,108,200},
          thickness=0.5));
      ...
      connect(resCHW.port_b, chiWSE.port_a2) annotation (Line(points={{650,-188},{
          ...
          thickness=0.5));
      connect(temDifPreRes.TSet,oveTChiWatSupSet. u) annotation (Line(points={{1217,
              -249},{1230,-249},{1230,-276},{1186,-276},{1186,-300},{1198,-300}},
            color={0,0,127}));
      connect(temDifPreRes.dpSet, oveDifPreChiWatSet.u) annotation (Line(points=
             {{1217,-239},{1220.5,-239},{1220.5,-222},{1252,-222}}, color={0,0,
              127}));
      connect(oveDifPreChiWatSet.y, dpSetGai.u) annotation (Line(
          points={{1275,-222},{1280,-222},{1280,-234},{1248,-234},{1248,-248},{
              1254,-248}},
          color={238,46,47},
          thickness=0.5));
      connect(oveOnConWatPum.y, gai.u) annotation (Line(
          points={{1309,-234},{1320,-234},{1320,-206},{1324,-206}},
          color={238,46,47},
          thickness=0.5));
      connect(CWPumCon.y[1], oveOnConWatPum.u) annotation (Line(points={{1305,-206.5},
              {1308,-206.5},{1308,-218},{1282,-218},{1282,-234},{1286,-234}},
            color={0,0,127}));
      connect(TCWSupSet.y, oveTConWatSupSet.u) annotation (Line(points={{1217,-90},
              {1224,-90},{1224,-124},{1194,-124},{1194,-140},{1200,-140}},
            color={0,0,127}));
      connect(oveTConWatSupSet.y, cooTowSpeCon.TCWSupSet) annotation (Line(
          points={{1223,-140},{1262,-140},{1262,-90},{1284,-90}},
          color={238,46,47},
          thickness=0.5));

      connect(TCHWRet.port_a, resCHW.port_a) annotation (Line(
          points={{600,-188},{630,-188}},
          color={28,108,200},
          thickness=0.5));
...
First implementation.
    ...
    partial model PartialHotWaterside
      ...
      Buildings.Fluid.Actuators.Valves.TwoWayEqualPercentage HWVal(
        ...
        annotation (Placement(transformation(
            ...
            rotation=270,
            origin={98,-180})));
      Buildings.Fluid.Sources.Boundary_pT expVesBoi(
        redeclare replaceable package Medium = MediumW,
        T=318.15,
        nPorts=1)
        "Expansion tank"
        annotation (Placement(transformation(extent={{10,-10},{-10,10}},
            rotation=180,
            origin={58,-319})));
      Modelica.Fluid.Sensors.TemperatureTwoPort THWRet(redeclare replaceable
          package Medium = MediumW)
      ...
      Modelica.Fluid.Sensors.TemperatureTwoPort THWSup(redeclare replaceable
          package Medium = MediumW)
      ...
      Buildings.Fluid.Sensors.MassFlowRate   senHWFlo(redeclare package Medium =
        ...
        "Sensor for hot water flow rate" annotation (Placement(transformation(
            ...
            rotation=-90,
            origin={98,-278})));
      Buildings.Controls.Continuous.LimPID boiTSupCon(
        Td=1,
        k=0.5,
        controllerType=Modelica.Blocks.Types.SimpleController.PI,
        Ti=100) "Boiler supply water temperature controller"
      ...
      FaultInjection.Utilities.Overwrite.OverwriteVariable oveTBoiSupSet(
          description="Boiler supply water temperature setpoint", u(
          unit="K",
          min=273.15 + 40,
          max=273.15 + 48))
        "overwrite boiler supply water temperature setpoint" annotation (
          Placement(transformation(extent={{-124,-238},{-104,-218}})));
      FaultInjection.Utilities.Overwrite.OverwriteVariable oveDifPreHotWatSet(
          description="Hot water loop differential pressure setpoint", u(
          unit="Pa",
          min=18000,
          max=36000)) "overwrite hot water loop differential pressure setpoint"
        annotation (Placement(transformation(extent={{-126,-272},{-106,-252}})));
    equation
      ...
      connect(boi.port_b, pumHW.port_a)
        annotation (Line(points={{150,-320},{198,-320}},color={255,85,170},
          thickness=0.5));
      connect(pumHW.port_b, boiIsoVal.port_a)
        annotation (Line(points={{218,-320},{282,-320}}, color={255,85,170},
          thickness=0.5));
      ...
      connect(resHW.port_b, boiIsoVal.port_b) annotation (Line(points={{350,-270},{
              350,-320},{302,-320}},       color={255,85,170},
          thickness=0.5));
      connect(expVesBoi.ports[1], boi.port_a) annotation (Line(points={{68,-319},{
              100,-319},{100,-320},{130,-320}},
                                          color={255,85,170},
          thickness=0.5));
      connect(boiTSupCon.u_m, boi.T) annotation (Line(points={{-64,-290},{-64,-296},
              {-98,-296},{-98,-64},{160,-64},{160,-312},{151,-312}}, color={0,0,127}));
      connect(senHWFlo.m_flow, minFloBypHW.m_flowHW) annotation (Line(points={{87,-278},
              {72,-278},{72,-70},{-96,-70},{-96,-245},{-76,-245}},     color={0,0,127}));
      connect(valBypBoi.port_a, senHWFlo.port_a) annotation (Line(points={{220,-252},
              {98,-252},{98,-268}}, color={255,85,170},
          thickness=0.5));
      connect(THWRet.port_b, senHWFlo.port_a)
        annotation (Line(points={{98,-236},{98,-268}}, color={255,85,170},
          thickness=0.5));
      connect(senHWFlo.port_b, boi.port_a) annotation (Line(points={{98,-288},{98,
              -320},{130,-320}}, color={255,85,170},
          thickness=0.5));
      connect(valBypBoi.port_b, resHW.port_b) annotation (Line(points={{240,-252},{
              320,-252},{320,-290},{350,-290},{350,-270}}, color={255,85,170},
          thickness=0.5));
      connect(boiTSupCon.y, proBoi.u2)
      ...
      connect(proBoi.y, boi.y) annotation (Line(points={{-10,-272},{12,-272},{12,
              -358},{120,-358},{120,-312},{128,-312}},
                                 color={0,0,127}));
      connect(triResHW.TSet,oveTBoiSupSet. u) annotation (Line(points={{-135,-231},{
              -129.5,-231},{-129.5,-228},{-126,-228}},        color={0,0,127}));
      connect(oveTBoiSupSet.y, boiTSupCon.u_s) annotation (Line(
          points={{-103,-228},{-100,-228},{-100,-278},{-76,-278}},
          color={255,0,0},
          thickness=0.5));
      connect(triResHW.dpSet, oveDifPreHotWatSet.u) annotation (Line(points={{-135,
              -221},{-132,-221},{-132,-262},{-128,-262}}, color={0,0,127}));
      connect(oveDifPreHotWatSet.y, dpSetGaiHW.u) annotation (Line(
          points={{-105,-262},{-102,-262},{-102,-282},{-128,-282},{-128,-300},{
              -122,-300}},
          color={238,46,47},
          thickness=0.5));
  ...
  thermal zones: this is a copy of Buildings.Examples.VAVReheat.BaseClasses.PartialOpenLoop"
    ...
    //    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
      ...
      Modelica.Fluid.Sensors.TemperatureTwoPort  TSup(
        redeclare package Medium = MediumA)
      ...
      Modelica.Fluid.Sensors.TemperatureTwoPort TRet(
        redeclare package Medium = MediumA) "Return air temperature sensor"
        annotation (Placement(transformation(extent={{110,130},{90,150}})));
      Modelica.Fluid.Sensors.TemperatureTwoPort TMix(
    ...
    public
      ...
      FaultInjection.Utilities.Overwrite.OverwriteVariable oveTDryBulOutAir(
          description="Outdoor air dry bulb temperature", u(
          unit="K",
          min=273.15 - 60,
          max=273.15 + 60)) "Overwrite outdoor air dry bulb temperature"
    ...
    equation
      ...
      connect(heaCoi.port_b2, cooCoi.port_a2) annotation (Line(
          ...
          color={170,213,255},
          thickness=0.5));
      connect(weaBus.TDryBul, oveTDryBulOutAir.u) annotation (Line(
          points={{-320,180},{-312,180},{-312,150},{-302,150}},
          color={255,204,51},
          thickness=0.5), Text(
          string="%first",
          index=-1,
          extent={{-6,3},{-6,3}},
          horizontalAlignment=TextAlignment.Right));
      connect(oveTDryBulOutAir.y, TOut.u) annotation (Line(points={{-279,150},{
              -262,150},{-262,166},{-308,166},{-308,180},{-302,180}}, color={0,
              0,127}));
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">issue 426</a>.
    ...
    partial model PartialAirside
      ...
      FaultInjection.AirLoopControl.AHUController                         conAHU(
        final pMaxSet=410,
    ...
    equation
      ...
      connect(dpDisSupFan.p_rel, conAHU.ducStaPre) annotation (Line(points={{311,0},
              {144,0},{144,620.444},{336,620.444}},        color={0,0,127}));
      annotation (
