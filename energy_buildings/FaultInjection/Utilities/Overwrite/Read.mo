...
model Read "Block that allows a signal to be read as an FMU output"
  ...
  parameter String zone = "1" if (KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.AirZoneTemperature
     or KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.RadiativeZoneTemperature
     or KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.OperativeZoneTemperature
     or KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.RelativeHumidity
     or KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.CO2Concentration)
    ...
    or CO2Concentration"
  annotation(Dialog(enable=(KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.AirZoneTemperature
           or KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.RadiativeZoneTemperature
           or KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.OperativeZoneTemperature
           or KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.RelativeHumidity
           or KPIs == FaultInjection.Utilities.Overwrite.SignalTypes.SignalsForKPIs.CO2Concentration)));
