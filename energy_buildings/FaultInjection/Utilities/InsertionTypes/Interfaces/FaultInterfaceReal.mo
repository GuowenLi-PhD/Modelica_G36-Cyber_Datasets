...
partial block FaultInterfaceReal
  "Fault injection interface for real inputs and outputs"

  FaultInjection.Utilities.InsertionTypes.Interfaces.RealInput
            u "Connector of Real input signal" annotation (Placement(
        transformation(extent={{-140,-20},{-100,20}})));
  FaultInjection.Utilities.InsertionTypes.Interfaces.RealOutput
