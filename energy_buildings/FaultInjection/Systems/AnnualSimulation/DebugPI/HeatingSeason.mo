...
model HeatingSeason "System example for fault injection"
  extends Modelica.Icons.Example;
  extends
    FaultInjection.Systems.AnnualSimulation.BaseClasses.PartialHotWaterside(
    ...
    minFloBypHW(k=0.1),
    resHW(diameter=0.05),
    valBypBoi(use_inputFilter=true));
  extends
    FaultInjection.Systems.AnnualSimulation.BaseClasses.PartialAirside(
  ...
  extends
    FaultInjection.Systems.AnnualSimulation.BaseClasses.PartialWaterside(
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant yBypOff(final k=0)
    "off" annotation (Placement(transformation(extent={{180,-240},{200,-220}})));
equation
  ...
  connect(minFloBypHW.y, valBypBoi.y) annotation (Line(points={{-53,-248},{214,
          -248},{214,-228},{230,-228},{230,-240}}, color={0,0,127}));
   annotation (
...
experiment(
    ...
    __Dymola_Commands(file=
          "modelica://FaultInjection/Resources/Scripts/dymola/Systems/AnnualSimulation/DebugPI/HeatingSeason.mos"
        "Simulate and Plot"));
end HeatingSeason;
