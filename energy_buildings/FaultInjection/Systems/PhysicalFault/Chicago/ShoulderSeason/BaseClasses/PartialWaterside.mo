...
partial model PartialWaterside
 ...
 // WSE parameters
  ...
  Buildings.Fluid.Delays.DelayFirstOrder del(
    ...
    tau=120,
    nPorts=2)
    annotation (Placement(transformation(extent={{726,-188},{746,-168}})));
equation
  ...
  connect(resCHW.port_b, TCHWSup.port_a) annotation (Line(
      points={{780,-188},{908,-188},{908,-128},{778,-128}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(resCHW.port_a, del.ports[2]) annotation (Line(
      points={{760,-188},{738,-188}},
      color={0,127,255},
      thickness=0.5));
  connect(chiWSE.port_b2, del.ports[1]) annotation (Line(
      points={{694,-202},{708,-202},{708,-188},{734,-188}},
      color={0,127,255},
      thickness=0.5));
