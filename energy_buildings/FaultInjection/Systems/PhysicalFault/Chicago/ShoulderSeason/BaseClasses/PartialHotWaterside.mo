...
partial model PartialHotWaterside
  ...
  Equipment.VariableFaults.StuckValve HWVal(
  ...
  Buildings.Fluid.FixedResistances.Pipe resHW(
    ...
    lambdaIns=0.04,
    length=0,
    v_nominal=1) "Resistance in hot water loop" annotation (Placement(
        transformation(
        extent={{-10,10},{10,-10}},
        rotation=-90,
        origin={350,-230})));
  ...
  FaultInjection.Experimental.SystemLevelFaults.Controls.TrimResponse
    triResHW(
    uTri=0.9,
  ...
  parameter Utilities.InsertionTypes.Generic.faultMode faultHeaVavStu(startTime=
       259200, endTime=864000) "Cooling coil valve stuck fault"
    annotation (Placement(transformation(extent={{108,-164},{128,-144}})));
  Buildings.HeatTransfer.Sources.FixedTemperature TEnvHea(T=299.15)
...
equation
  ...
  connect(HWVal.y_actual, triResHW.u) annotation (Line(points={{90.8,-185},{
          90.8,-200},{70,-200},{70,-66},{-180,-66},{-180,-226},{-158,-226}},
                                                      color={0,0,127}));
  connect(senRelPreHW.port_a, resHW.port_a) annotation (Line(
      points={{208,-206},{350,-206},{350,-220}},
      color={238,46,47},
      thickness=0.5));
  connect(valBypBoi.port_b, resHW.port_b) annotation (Line(
      points={{240,-252},{350,-252},{350,-240}},
      color={238,46,47},
      thickness=0.5));
  connect(resHW.port_b, THWSup.port_a) annotation (Line(
      points={{350,-240},{350,-284}},
      color={238,46,47},
      thickness=0.5));
  connect(boiIsoVal.port_b, THWSup.port_b) annotation (Line(
      ...
      color={238,46,47},
      thickness=0.5));
  connect(TEnvHea.port, resHW.heatPort) annotation (Line(points={{320,-230},{
          334,-230},{334,-230},{345,-230}}, color={191,0,0}));
