...
model BaselineSystem "System example for fault injection"
  ...
  extends
    FaultInjection.Systems.PhysicalFault.Chicago.ShoulderSeason.BaseClasses.PartialHotWaterside(
  ...
  extends
    FaultInjection.Systems.PhysicalFault.Chicago.ShoulderSeason.BaseClasses.PartialAirside(
    faultSupDucLea(startTime=11836800, endTime=12441600),
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
    ...
    flo(
      ...
      temAirSou(bias(k=1.2)),
      faulttemAirEas=faulttemAirEas,
      faulttemAirSou=faulttemAirSou),
    faultOADamStu(startTime=11836800, endTime=12441600),
    faultVOut(startTime=11836800, endTime=12441600),
    VOut1(use_uFau_in=false, sca(k=1.1)),
    faultTMix(startTime=11836800, endTime=12441600),
    faultTRet(startTime=11836800, endTime=12441600),
    faultTSup(startTime=11836800, endTime=12441600),
    faultVSupSou_flow(startTime=11836800, endTime=12441600),
    faultTSupSou(startTime=11836800, endTime=12441600),
    TMix(use_uFau_in=false, bias(k=1)),
    TRet(use_uFau_in=false, bias(k=1)),
    TSup(use_uFau_in=false, bias(k=1)),
    VSupSou_flow(use_uFau_in=false, sca(k=1.1)),
    TSupSou(use_uFau_in=false, bias(k=1)),
    faultdpDisSupFan(startTime=11836800, endTime=12441600),
    dpDisSupFan(bias(k=15)),
    faultSupFanSpeDel(startTime=11836800, endTime=12441600),
    faultyCooDel(startTime=11836800, endTime=12441600));
  ...
  extends
    FaultInjection.Systems.PhysicalFault.Chicago.ShoulderSeason.BaseClasses.PartialWaterside(
    resCHW(dp_nominal=139700, diameter=0.065,
      length=25),
    faultRelPre(startTime=11836800, endTime=12441600),
    redeclare
    ...
    pumSpe(yMin=0.2),
    faultCoiVavStu(startTime=11836800, endTime=12441600),
    faultTCHWSup(startTime=11836800, endTime=12441600),
    TCHWSup(
      faultMode=faultTCHWSup,
      use_uFau_in=false,
      bias(k=-2)),
    faultTCWSup(startTime=11836800, endTime=12441600),
    TCWSup(use_uFau_in=false, bias(k=1)),
    senRelPre(use_uFau_in=false, bias(k=36000*0.1)),
    faultCHWDifPre(startTime=11836800, endTime=12441600),
    faultCHWTSupSet(startTime=11836800, endTime=12441600),
    chiFauMod(each startTime=11836800, each endTime=12441600),
    del(tau=1));
  ...
  parameter Utilities.InsertionTypes.Generic.faultMode faulttemAirSou(startTime=
       11836800, endTime=12441600) "South zone air temperature sensor fault"
  ...
  parameter Utilities.InsertionTypes.Generic.faultMode faulttemAirEas(startTime=
       11836800, endTime=12441600) "East zone air temperature sensor fault"
...
equation
  ...
  connect(boiPlaEnaDis.yPla, triResHW.uDevSta) annotation (Line(points={{-257,
          -160},{-240,-160},{-240,-80},{-182,-80},{-182,-221},{-160,-221}},
                                                      color={255,0,255}));
  ...
  connect(proHWVal.y, HWVal.y) annotation (Line(points={{58,-206},{68,-206},{68,
          -180},{86.2,-180}},
                            color={0,0,127}));
  ...
  connect(yCooDel.y, proCHWVal.u1) annotation (Line(points={{481,530},{492,530},
          {492,468},{440,468},{440,42},{382,42},{382,-198},{410,-198}}, color={
          235,0,0}));
  connect(yCooDel.y, plaReqChi.uPlaVal) annotation (Line(points={{481,530},{488,
          530},{488,466},{448,466},{448,30},{384,30},{384,-72},{998,-72},{998,
  ...
  connect(yPumDel.y, chiWSE.yPum[1]) annotation (Line(points={{1435,-246},{1436,
          ...
          0,0}));
  connect(heaCoi.port_a1, resHW.port_a) annotation (Line(
      points={{118,-52},{138,-52},{138,-140},{350,-140},{350,-220}},
      color={238,46,47},
      thickness=0.5));
   annotation (
...
experiment(
    ...
    __Dymola_Commands(file=
          "modelica://FaultInjection/Resources/Scripts/dymola/Systems/PhysicalFault/Chicago/ShoulderSeason/BaselineSystem.mos"
        "Simulate and Plot"));
end BaselineSystem;
