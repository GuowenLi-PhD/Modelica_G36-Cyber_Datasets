...
model BaselineSystem "System example for fault injection"
  ...
  extends
    FaultInjection.Systems.PhysicalFault.Chicago.CoolingSeason.BaseClasses.PartialHotWaterside(
  ...
  extends
    FaultInjection.Systems.PhysicalFault.Chicago.CoolingSeason.BaseClasses.PartialAirside(
    faultSupDucLea(startTime=17625600, endTime=18230400),
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
    ...
    faultOADamStu(startTime=17625600, endTime=18230400),
    faultVOut(startTime=17625600, endTime=18230400),
    VOut1(use_uFau_in=false, sca(k=1.1)),
    faultTMix(startTime=17625600, endTime=18230400),
    faultTRet(startTime=17625600, endTime=18230400),
    faultTSup(startTime=17625600, endTime=18230400),
    faultVSupSou_flow(startTime=17625600, endTime=18230400),
    faultTSupSou(startTime=17625600, endTime=18230400),
    ...
    faultdpDisSupFan(startTime=17625600, endTime=18230400),
    dpDisSupFan(bias(k=15)),
    faultSupFanSpeDel(startTime=17625600, endTime=18230400),
    faultyCooDel(startTime=17625600, endTime=18230400));
  ...
  extends
    FaultInjection.Systems.PhysicalFault.Chicago.CoolingSeason.BaseClasses.PartialWaterside(
  ...
  parameter Utilities.InsertionTypes.Generic.faultMode faulttemAirSou(startTime=
       17625600, endTime=18230400) "South zone air temperature sensor fault"
  ...
  parameter Utilities.InsertionTypes.Generic.faultMode faulttemAirEas(startTime=
       17625600, endTime=18230400) "East zone air temperature sensor fault"
    annotation (Placement(transformation(extent={{1100,540},{1120,560}})));
equation
  ...
  connect(heaCoi.port_a1, resHW.port_a) annotation (Line(
      points={{118,-52},{140,-52},{140,-140},{350,-140},{350,-220}},
      color={255,0,0},
      thickness=0.5));
   annotation (
...
experiment(
    ...
    __Dymola_Commands(file=
          "modelica://FaultInjection/Resources/Scripts/dymola/Systems/PhysicalFault/Chicago/CoolingSeason/BaselineSystem.mos"
        "Simulate and Plot"));
end BaselineSystem;
