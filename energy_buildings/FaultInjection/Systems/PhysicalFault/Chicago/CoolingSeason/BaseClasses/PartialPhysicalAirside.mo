within FaultInjection.Systems.PhysicalFault.Chicago.CoolingSeason.BaseClasses;
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  FaultInjection.Systems.PhysicalFault.Chicago.BaseClasses.Floor flo(
...
equation
  ...
  connect(TRooAir.u, flo.TRooAir) annotation (Line(
      points={{488,170},{480,170},{480,514},{1164,514},{1164,491.333},{1094.14,
          491.333}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
