...
partial model PartialAirside
  ...
  extends
    FaultInjection.Systems.PhysicalFault.Chicago.CoolingSeason.BaseClasses.PartialPhysicalAirside(
  ...
  parameter Utilities.InsertionTypes.Generic.faultMode faultyCooDel
    ...
    annotation (Placement(transformation(extent={{500,520},{520,540}})));
equation
  ...
  connect(flo.TRooAir, TZonSet.TZon) annotation (Line(points={{1094.14,491.333},
          {1164,491.333},{1164,666},{50,666},{50,313},{58,313}}, color={0,0,127}));
  ...
  connect(freSta.y, andFreSta.u1) annotation (Line(points={{22,-92},{28,-92},{
          28,-112},{-40,-112},{-40,-130},{-22,-130}},
                                                 color={255,0,255}));
  connect(eco.yOut, conAHU.yOutDamPos) annotation (Line(points={{-10,-34},{-10,
          36},{446,36},{446,522},{424,522},{424,522.667}},     color={0,0,127}));
  ...
  connect(yCooDel.u, conAHU.yCoo) annotation (Line(points={{458,530},{446,530},
