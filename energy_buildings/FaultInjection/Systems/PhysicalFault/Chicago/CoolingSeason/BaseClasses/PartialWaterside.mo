...
partial model PartialWaterside
 ...
 // WSE parameters
  ...
  Buildings.Fluid.FixedResistances.Pipe resCHW(
    ...
    lambdaIns=0.04,
    length=0,
    v_nominal=1.2) "Resistance in chilled water loop"
    annotation (Placement(transformation(extent={{760,-198},{780,-178}})));
  ...
  Buildings.HeatTransfer.Sources.FixedTemperature TEnvCoo(T=299.15)
  ...
  Buildings.Fluid.Delays.DelayFirstOrder del(
    ...
    tau=120,
    nPorts=2)
    annotation (Placement(transformation(extent={{724,-210},{744,-190}})));
equation
