within FaultInjection.Systems.PhysicalFault.BaseClasses;
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  Equipment.VariableFaults.FaultRelativePressureSensor dpDisSupFan(redeclare
    ...
    "Supply fan static discharge pressure sensor fault" annotation (Placement(
        ...
        rotation=90,
        origin={320,0})));
  Buildings.Controls.SetPoints.OccupancySchedule occSch(occupancy=3600*{7,19})
    "Occupancy schedule"
  ...
  Equipment.VariableFaults.FaultFlowSensor
                                         VOut1(redeclare package Medium =
        MediumA, m_flow_nominal=m_flow_nominal,
  ...
  FaultInjection.Systems.BaseClasses.Floor flo(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TSupCor(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={580,92})));
  Equipment.VariableFaults.FaultTemperatureSensor TSupSou(
    redeclare package Medium = MediumA,
    initType=Modelica.Blocks.Types.Init.InitialState,
    m_flow_nominal=mSou_flow_nominal,
    allowFlowReversal=allowFlowReversal,
    faultMode=faultTSupSou) "Discharge air temperature" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={760,92})));
  ...
  Equipment.VariableFaults.FaultFlowSensor
    ...
    m_flow_nominal=mSou_flow_nominal,
    allowFlowReversal=allowFlowReversal,
    faultMode=faultVSupSou_flow)         "Discharge air flow rate" annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={760,130})));
...
public
  ...
  parameter Utilities.InsertionTypes.Generic.faultMode faultTSupSou
    "South zone discharge air temperature sensor fault"
    annotation (Placement(transformation(extent={{788,80},{808,100}})));
  parameter Utilities.InsertionTypes.Generic.faultMode faultVSupSou_flow
    "South zone discharge air flow rate sensor fault"
    annotation (Placement(transformation(extent={{788,120},{808,140}})));
...
equation
  ...
  connect(TRooAir.u, flo.TRooAir) annotation (Line(
      points={{488,170},{480,170},{480,514},{1164,514},{1164,491.333},{
          1094.14,491.333}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
