...
model BaselineSystem
  extends FaultInjection.Systems.PhysicalFault.Chicago.HeatingSeason.BaselineSystem(
  ...
  annotation (experiment(
    ...
    __Dymola_Commands(file="modelica://FaultInjection/Resources/Scripts/dymola/Systems/PhysicalFault/Tuscaloosa/HeatingSeason/BaselineSystem.mos"
        "Simulate and Plot"));
end BaselineSystem;
