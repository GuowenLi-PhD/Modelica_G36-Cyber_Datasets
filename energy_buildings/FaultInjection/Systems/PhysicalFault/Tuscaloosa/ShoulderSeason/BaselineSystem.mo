...
model BaselineSystem
  extends FaultInjection.Systems.PhysicalFault.Chicago.ShoulderSeason.BaselineSystem(
  ...
  annotation (experiment(
    ...
    __Dymola_Commands(file="modelica://FaultInjection/Resources/Scripts/dymola/Systems/PhysicalFault/Tuscaloosa/ShoulderSeason/BaselineSystem.mos"
        "Simulate and Plot"));
end BaselineSystem;
