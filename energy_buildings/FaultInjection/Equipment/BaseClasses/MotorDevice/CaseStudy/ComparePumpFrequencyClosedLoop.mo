...
model ComparePumpFrequencyClosedLoop
  ...
  Modelica.Blocks.Sources.Constant Vrms1(k=120)
  ...
  Modelica.Blocks.Sources.Constant Vrms2(k=120)
  ...
  Modelica.Blocks.Sources.Step TSou2(
    ...
    height=4,
    offset=273.15 + 24)
    annotation (Placement(transformation(extent={{-138,-314},{-118,-294}})));
  Modelica.Blocks.Sources.Step TSou3(
    startTime=1000,
    height=4,
    offset=273.15 + 24)
    annotation (Placement(transformation(extent={{-138,-546},{-118,-526}})));
equation
  ...
  connect(TSou2.y, souHot2.T_in)
    annotation (Line(points={{-117,-304},{-62,-304}}, color={0,0,127}));
  connect(TSou3.y, souHot3.T_in)
    annotation (Line(points={{-117,-536},{-54,-536}}, color={0,0,127}));
  annotation (Diagram(
    ...
    __Dymola_Commands(file=
        ...
        "Simulate and Plot"));
end ComparePumpFrequencyClosedLoop;
