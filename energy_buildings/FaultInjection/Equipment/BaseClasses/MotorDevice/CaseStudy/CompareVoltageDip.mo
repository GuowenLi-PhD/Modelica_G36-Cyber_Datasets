...
model CompareVoltageDip
  ...
  parameter Buildings.Fluid.Movers.Data.Generic per3(
    ...
    motorEfficiency(V_flow={0.03529,0.04285}, eta={0.8187,0.8591}))
  ...
  Buildings.Controls.Continuous.LimPID preCon3(
    ...
    yMin=0)  annotation (Placement(transformation(extent={{-72,-222},{-52,-202}})));
...
equation
  ...
  connect(pro1.y, pum1.Vas[1, :]) annotation (Line(points={{-159,50},{-136,50},{
          -136,100},{-8,100},{-8,79},{8,79}}, color={0,0,127}));
  connect(pro2.y, pum1.Vbs[1, :]) annotation (Line(points={{-159,10},{-134,10},{
          -134,98},{-10,98},{-10,76},{8,76}}, color={0,0,127}));
  connect(pro3.y, pum1.Vcs[1, :]) annotation (Line(points={{-159,-30},{-132,-30},
          {-132,96},{-12,96},{-12,73},{8,73}}, color={0,0,127}));
  annotation (Diagram(
        ...
        Rectangle(extent={{-292,148},{-150,-56}}, lineColor={28,108,200})}),
    experiment(StopTime=1600),
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Examples/SimpleElectricPumpClosedLoop.mos"
        "Simulate and Plot"));
end CompareVoltageDip;
