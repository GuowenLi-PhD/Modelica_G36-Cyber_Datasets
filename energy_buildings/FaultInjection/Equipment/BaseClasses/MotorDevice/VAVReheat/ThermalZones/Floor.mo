within FaultInjection.Equipment.BaseClasses.MotorDevice.VAVReheat.ThermalZones;
model Floor "Model of a floor of the building"
  ...
  parameter Modelica.SIunits.Area furAreCor = 262.52 "Furniture area in core, used for adjustable thermal mass";
  parameter Modelica.SIunits.Area furAreSou = 414.68 "Furniture area in south, used for adjustable thermal mass";
  parameter Modelica.SIunits.Area furAreNor = 414.68 "Furniture area in north, used for adjustable thermal mass";
  parameter Modelica.SIunits.Area furAreEas = 262.52 "Furniture area in east, used for adjustable thermal mass";
  parameter Modelica.SIunits.Area furAreWes = 262.52 "Furniture area in west, used for adjustable thermal mass";
...
equation
  ...
  connect(replicator.y, nor.uSha) annotation (Line(
      points={{-19,180},{130,180},{130,154},{140.4,154}},
      color={0,0,127},
      pattern=LinePattern.Dash,
      smooth=Smooth.None));
  ...
  connect(nor.ports[1], portsNor[1]) annotation (Line(
      points={{147,122.8},{114,122.8},{114,126},{80,126}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(nor.ports[2], portsNor[2]) annotation (Line(
      points={{147,124.4},{124,124.4},{124,126},{100,126}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(opeNorCor.port_a2, nor.ports[5]) annotation (Line(
      points={{100,78},{124,78},{124,129.2},{147,129.2}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
