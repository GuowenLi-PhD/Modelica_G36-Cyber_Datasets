within FaultInjection.Equipment.BaseClasses.MotorDevice.VAVReheat;
model case2s3
  "Variable air volume flow system with terminal reheat and five thermal zones for s3 where the setpoint is reset 2 degree below for an hour"
  extends Modelica.Icons.Example;
  extends MotorDevice.VAVReheat.BaseClasses.PartialOpenLoopMotor;
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Controller conAHU(
    ...
    AFlo=AFlo,
    yFanMin=yFanMin,
    supFan(conSpe(Ni=10))) "AHU controller"
    annotation (Placement(transformation(extent={{384,362},{424,470}})));
 //supFan(conSpe(Ni=Modelica.Constants.inf)),
...
public
  Modelica.Blocks.Math.BooleanToReal b2r
    annotation (Placement(transformation(extent={{310,90},{330,110}})));
  Modelica.Blocks.Continuous.Filter filter(f_cut=1/20)
    annotation (Placement(transformation(extent={{370,50},{390,70}})));
  Modelica.ComplexBlocks.ComplexMath.ComplexToReal complexToReal1
    annotation (Placement(transformation(extent={{540,-180},{520,-160}})));
  ...
  Modelica.ComplexBlocks.ComplexMath.ComplexToReal complexToReal3
    annotation (Placement(transformation(extent={{540,-260},{520,-240}})));
  Modelica.ComplexBlocks.Sources.ComplexConstant a(k(re=cos(0), im=sin(0)))
    annotation (Placement(transformation(extent={{600,-180},{580,-160}})));
  Modelica.ComplexBlocks.Sources.ComplexConstant b(k(re=cos(-2/3*pi), im=sin(-2
          /3*pi)))
    annotation (Placement(transformation(extent={{600,-220},{580,-200}})));
  Modelica.ComplexBlocks.Sources.ComplexConstant c(k(re=cos(2/3*pi), im=sin(2/3
          *pi)))
    annotation (Placement(transformation(extent={{600,-260},{580,-240}})));
  Buildings.Controls.OBC.CDL.Continuous.Product pro4
    annotation (Placement(transformation(extent={{260,-100},{280,-80}})));
  Modelica.Blocks.Sources.CombiTimeTable setPoi(
    timeScale(displayUnit="h") = 3600,
    startTime(displayUnit="h"),
    table=[4896,273.15 + 30,273.15 + 20; 4901.5,273.15 + 30,273.15 + 20; 4901.5,
        273.15 + 24,273.15 + 20; 4902,273.15 + 24,273.15 + 20; 4902,273.15 + 21,
        273.15 + 20; 4909,273.15 + 21,273.15 + 20; 4909,273.15 + 25,273.15 + 20;
        4911,273.15 + 25,273.15 + 20; 4911,273.15 + 24,273.15 + 20; 4915,273.15
         + 24,273.15 + 20; 4915,273.15 + 30,273.15 + 20; 4920,273.15 + 30,
        273.15 + 20])
    "Temperature setpoints to overwrite the guiline36 temperature reset control"
    annotation (Placement(transformation(extent={{60,340},{80,360}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant vol(final k=1)
    "Flow rate signal for heating coil when freeze stat is on"
    annotation (Placement(transformation(extent={{82,-318},{102,-298}})));
equation
  ...
  connect(conVAVCor.TZooHeaSet, setPoi.y[2]) annotation (Line(points={{529,47},
          {480,47},{480,350},{81,350}},         color={0,0,127}));
  connect(conVAVCor.TRooCooSet, setPoi.y[1]) annotation (Line(points={{529,45},
          {480,45},{480,350},{81,350}},         color={0,0,127}));
  connect(conVAVSou.TZooHeaSet, setPoi.y[2]) annotation (Line(points={{699,45},
          {660,45},{660,350},{81,350}},         color={0,0,127}));
  connect(conVAVSou.TRooCooSet, setPoi.y[1]) annotation (Line(points={{699,43},
          {660,43},{660,350},{81,350}},         color={0,0,127}));
  connect(conVAVEas.TZooHeaSet, setPoi.y[2]) annotation (Line(points={{879,45},
          {850,45},{850,350},{81,350}},         color={0,0,127}));
  connect(conVAVEas.TRooCooSet, setPoi.y[1]) annotation (Line(points={{879,43},
          {850,43},{850,350},{81,350}},         color={0,0,127}));
  connect(conVAVNor.TZooHeaSet, setPoi.y[2]) annotation (Line(points={{1039,45},
          {1020,45},{1020,350},{81,350}},          color={0,0,127}));
  connect(conVAVNor.TRooCooSet, setPoi.y[1]) annotation (Line(points={{1039,43},
          {1020,43},{1020,350},{81,350}},          color={0,0,127}));
  connect(conVAVWes.TZooHeaSet, setPoi.y[2]) annotation (Line(points={{1239,43},
          {1202,43},{1202,350},{81,350}},          color={0,0,127}));
  connect(conVAVWes.TRooCooSet, setPoi.y[1]) annotation (Line(points={{1239,41},
          {1202,41},{1202,350},{81,350}},          color={0,0,127}));
  ...
  connect(TSetZon.TZon, flo.TRooAir) annotation (Line(points={{59,315},{59,
          314},{46,314},{46,626},{1164,626},{1164,491.333},{1094.14,491.333}},
                                                                          color=
         {0,0,127}));
  connect(conAHU.TZon, flo.TRooAir) annotation (Line(points={{383,452},{280,
          452},{280,622},{1164,622},{1164,491.333},{1094.14,491.333}},
        color={0,0,127}));
  ...
  connect(conAHU.VDis_flow, VBox_flow.y) annotation (Line(points={{383,400},{260,
  ...
  connect(conAHU.ySupFanSpe, freBas.u) annotation (Line(points={{425,438.4},{
          462,438.4},{462,0},{384,0}}, color={0,0,127}));
  connect(freBas.y, fanSup.f_in) annotation (Line(points={{361,0},{356,0},{356,
          -20},{302,-20},{302,-28}},     color={0,0,127}));
  connect(pro1[1].y, fanSup.Vas[1, 1]) annotation (Line(points={{381,-110},{400,
          -110},{400,-68},{268,-68},{268,-34},{298,-34}}, color={0,0,127}));
  connect(pro1[2].y, fanSup.Vas[1, 2]) annotation (Line(points={{381,-110},{400,
          -110},{400,-68},{268,-68},{268,-34},{298,-34}}, color={0,0,127}));
  connect(pro2[1].y, fanSup.Vbs[1, 1]) annotation (Line(points={{381,-150},{402,
          -150},{402,-66},{270,-66},{270,-38},{298,-38}}, color={0,0,127}));
  connect(pro2[2].y, fanSup.Vbs[1, 2]) annotation (Line(points={{381,-150},{402,
          -150},{402,-66},{270,-66},{270,-38},{298,-38}}, color={0,0,127}));
  connect(pro3[1].y, fanSup.Vcs[1, 1]) annotation (Line(points={{381,-190},{404,
          -190},{404,-64},{272,-64},{272,-42},{298,-42}}, color={0,0,127}));
  connect(pro3[2].y, fanSup.Vcs[1, 2]) annotation (Line(points={{381,-190},{404,
          -190},{404,-64},{272,-64},{272,-42},{298,-42}}, color={0,0,127}));
  connect(conAHU.ySupFan, b2r.u) annotation (Line(points={{425,450},{466,450},{
          466,226},{300,226},{300,100},{308,100}},
                                             color={255,0,255}));
  connect(a.y, complexToReal1.u)
    annotation (Line(points={{579,-170},{542,-170}},
                                                 color={85,170,255}));
  connect(b.y, complexToReal2.u)
    annotation (Line(points={{579,-210},{542,-210}},
                                                   color={85,170,255}));
  connect(c.y, complexToReal3.u)
    annotation (Line(points={{579,-250},{542,-250}},
                                                   color={85,170,255}));
  connect(filter.y, pro4.u1) annotation (Line(points={{391,60},{408,60},{408,20},
          {256,20},{256,-84},{258,-84}}, color={0,0,127}));
  connect(pro4.y, pro1[1].u1) annotation (Line(points={{281,-90},{320,-90},{320,
          -104},{358,-104}}, color={0,0,127}));
  connect(pro4.y, pro1[2].u1) annotation (Line(points={{281,-90},{320,-90},{320,
          -104},{358,-104}}, color={0,0,127}));
  connect(pro4.y, pro2[1].u1) annotation (Line(points={{281,-90},{320,-90},{320,
          -144},{358,-144}}, color={0,0,127}));
  connect(pro4.y, pro2[2].u1) annotation (Line(points={{281,-90},{320,-90},{320,
          -144},{358,-144}}, color={0,0,127}));
  connect(pro4.y, pro3[1].u1) annotation (Line(points={{281,-90},{320,-90},{320,
          -184},{358,-184}}, color={0,0,127}));
  connect(pro4.y, pro3[2].u1) annotation (Line(points={{281,-90},{320,-90},{320,
          -184},{358,-184}}, color={0,0,127}));
  connect(complexToReal1.re, pro1[1].u2) annotation (Line(points={{518,-164},{
          502,-164},{502,-236},{300,-236},{300,-116},{358,-116}}, color={0,0,
          127}));
  connect(complexToReal1.im, pro1[2].u2) annotation (Line(points={{518,-176},{
          502,-176},{502,-236},{300,-236},{300,-116},{358,-116}}, color={0,0,
          127}));
  connect(complexToReal2.re, pro2[1].u2) annotation (Line(points={{518,-204},{
          502,-204},{502,-236},{300,-236},{300,-156},{358,-156}}, color={0,0,
          127}));
  connect(complexToReal2.im, pro2[2].u2) annotation (Line(points={{518,-216},{
          502,-216},{502,-236},{300,-236},{300,-156},{358,-156}}, color={0,0,
          127}));
  connect(complexToReal3.re, pro3[1].u2) annotation (Line(points={{518,-244},{
          502,-244},{502,-236},{300,-236},{300,-196},{358,-196}}, color={0,0,
          127}));
  connect(complexToReal3.im, pro3[2].u2) annotation (Line(points={{518,-256},{
          502,-256},{502,-236},{300,-236},{300,-196},{358,-196}}, color={0,0,
          127}));
  connect(b2r.y, filter.u) annotation (Line(points={{331,100},{350,100},{350,60},
          {368,60}},                         color={0,0,127}));
  connect(setPoi.y[1], conAHU.TZonCooSet) annotation (Line(points={{81,350},{94,
          350},{94,464},{383,464}}, color={238,46,47}));
  connect(setPoi.y[2], conAHU.TZonHeaSet) annotation (Line(points={{81,350},{94,
          350},{94,468},{383,468}}, color={0,0,127}));
  connect(vol.y, pro4.u2) annotation (Line(points={{103,-308},{248,-308},{248,
          -96},{258,-96}}, color={0,0,127}));
  annotation (
