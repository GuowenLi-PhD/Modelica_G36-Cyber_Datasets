...
block RoomTemperatureSetpoint "Set point scheduler for room temperature"
  ...
  Modelica.Blocks.Sources.RealExpression setPoiHea(
     y(unit="K",displayUnit="degC")=if (mode.y == Integer(OperationModes.occupied) or mode.y == Integer(OperationModes.unoccupiedWarmUp)
  ...
  Modelica.Blocks.Sources.RealExpression setPoiCoo(
    y(unit="K",displayUnit="degC")=if (mode.y == Integer(OperationModes.occupied) or
