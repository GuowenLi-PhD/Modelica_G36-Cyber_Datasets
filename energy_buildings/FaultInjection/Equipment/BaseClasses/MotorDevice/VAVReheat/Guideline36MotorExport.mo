...
public
  ...
  Modelica.Blocks.Interfaces.RealInput Vrms(
    final unit="1") annotation (Placement(
        transformation(
        extent={{-20,-20},{20,20}},
        rotation=90,
        origin={250,-340})));
  Modelica.Blocks.Interfaces.RealOutput Sas[1,2](each quantity="Power", each
      unit="VA")
    annotation (Placement(transformation(extent={{640,-280},{660,-260}})));
  Modelica.Blocks.Interfaces.RealOutput Sbs[1,2](each quantity="Power", each
      unit="VA")
    annotation (Placement(transformation(extent={{640,-300},{660,-280}})));
  Modelica.Blocks.Interfaces.RealOutput Scs[1,2](each quantity="Power", each
      unit="VA")
    annotation (Placement(transformation(extent={{640,-320},{660,-300}})));
equation
  ...
  connect(conVAVCor.TZooHeaSet, TSetZon.TZonHeaSet[1]) annotation (Line(points=
          {{529,47},{480,47},{480,313},{81,313}}, color={0,0,127}));
  connect(conVAVCor.TRooCooSet, TSetZon.TZonCooSet[1]) annotation (Line(points=
          {{529,45},{480,45},{480,317},{81,317}}, color={0,0,127}));
  connect(conVAVSou.TZooHeaSet, TSetZon.TZonHeaSet[2]) annotation (Line(points=
          {{699,45},{660,45},{660,313},{81,313}}, color={0,0,127}));
  connect(conVAVSou.TRooCooSet, TSetZon.TZonCooSet[2]) annotation (Line(points=
          {{699,43},{660,43},{660,317},{81,317}}, color={0,0,127}));
  connect(conVAVEas.TZooHeaSet, TSetZon.TZonHeaSet[3]) annotation (Line(points=
          {{879,45},{850,45},{850,313},{81,313}}, color={0,0,127}));
  connect(conVAVEas.TRooCooSet, TSetZon.TZonCooSet[3]) annotation (Line(points=
          {{879,43},{850,43},{850,317},{81,317}}, color={0,0,127}));
  connect(conVAVNor.TZooHeaSet, TSetZon.TZonHeaSet[4]) annotation (Line(points=
          {{1039,45},{1020,45},{1020,313},{81,313}}, color={0,0,127}));
  connect(conVAVNor.TRooCooSet, TSetZon.TZonCooSet[4]) annotation (Line(points=
          {{1039,43},{1020,43},{1020,317},{81,317}}, color={0,0,127}));
  connect(conVAVWes.TZooHeaSet, TSetZon.TZonHeaSet[5]) annotation (Line(points=
          {{1239,43},{1202,43},{1202,313},{81,313}}, color={0,0,127}));
  connect(conVAVWes.TRooCooSet, TSetZon.TZonCooSet[5]) annotation (Line(points=
  ...
  connect(TSetZon.TZon, flo.TRooAir) annotation (Line(points={{59,315},{
          59,314},{46,314},{46,626},{1164,626},{1164,491.333},{1094.14,
          491.333}},                                                      color=
         {0,0,127}));
  connect(conAHU.TZonHeaSet, TSetZon.TZonHeaSet[1]) annotation (Line(points={{
          383,468},{110,468},{110,313},{81,313}}, color={0,0,127}));
  connect(conAHU.TZonCooSet, TSetZon.TZonCooSet[1]) annotation (Line(points={{
          383,464},{120,464},{120,317},{81,317}}, color={0,0,127}));
  connect(conAHU.TZon, flo.TRooAir) annotation (Line(points={{383,452},{
          280,452},{280,622},{1164,622},{1164,491.333},{1094.14,491.333}},
        color={0,0,127}));
  ...
  connect(complexToReal3.im, pro3[2].u2) annotation (Line(points={{518,-256},{
          ...
          127}));
  connect(Vrms, pro4.u2) annotation (Line(points={{250,-340},{250,-96},{258,-96}},
        color={0,0,127}));
  connect(fanSup.Sas, Sas) annotation (Line(points={{321,-42},{332,-42},{332,-60},
          {440,-60},{440,-100},{620,-100},{620,-270},{650,-270}}, color={0,0,127}));
  connect(fanSup.Sbs, Sbs) annotation (Line(points={{321,-44},{332,-44},{332,-60},
          {440,-60},{440,-100},{620,-100},{620,-290},{650,-290}}, color={0,0,127}));
  connect(fanSup.Scs, Scs) annotation (Line(points={{321,-46},{332,-46},{332,-60},
          {440,-60},{440,-100},{620,-100},{620,-310},{650,-310}}, color={0,0,127}));

  connect(b2r.y, filter.u) annotation (Line(points={{331,100},{348,100},{348,60},
          {368,60}}, color={0,0,127}));
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-380,-320},{1400,
            640}})),Documentation(info="<html>
