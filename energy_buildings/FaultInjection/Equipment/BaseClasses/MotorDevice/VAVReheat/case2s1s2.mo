...
public
  ...
  Modelica.Blocks.Math.Gain gain(k=1)
    annotation (Placement(transformation(extent={{126,-330},{146,-310}})));
  Modelica.Blocks.Math.Gain gain1(k=1)
    annotation (Placement(transformation(extent={{126,-370},{146,-350}})));
  ...
  Modelica.Blocks.Sources.Ramp volDow(
    duration=0.02,
    offset=1,
    startTime=204*24*3600 + 13*3600,
    height=-0.7) "Voltage ramp down"
    annotation (Placement(transformation(extent={{60,-330},{80,-310}})));
  Modelica.Blocks.Sources.Ramp volUp(
    offset=0,
    duration=0.02,
    startTime=204*24*3600 + 13*3600 + 0.32,
    height=0.7) "Voltage ramp up"
    annotation (Placement(transformation(extent={{60,-370},{80,-350}})));
equation
  ...
  connect(conAHU.yCoo, gaiCooCoi.u) annotation (Line(points={{425,376},{
          448,376},{448,-272},{90,-272},{90,-248},{98,-248}},     color={0,0,
          127}));
  ...
  connect(complexToReal3.im, pro3[2].u2) annotation (Line(points={{518,-256},{
          ...
          127}));
  connect(b2r.y, filter.u) annotation (Line(points={{331,100},{346,100},{346,
          104},{350,104},{350,60},{368,60}}, color={0,0,127}));
  connect(gain.y,vol. u1) annotation (Line(points={{147,-320},{150,-320},{150,
          -334},{158,-334}},
                      color={0,0,127}));
  connect(gain1.y,vol. u2) annotation (Line(points={{147,-360},{150,-360},{150,
          -346},{158,-346}},
                      color={0,0,127}));
  connect(pro4.u2, vol.y) annotation (Line(points={{258,-96},{248,-96},{248,
          -340},{181,-340}}, color={0,0,127}));
  connect(volDow.y, gain.u)
    annotation (Line(points={{81,-320},{124,-320}}, color={0,0,127}));
  connect(volUp.y, gain1.u)
    annotation (Line(points={{81,-360},{124,-360}}, color={0,0,127}));
  annotation (
