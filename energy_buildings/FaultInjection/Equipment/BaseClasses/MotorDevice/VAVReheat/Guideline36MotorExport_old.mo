...
model Guideline36MotorExport_old
 ...
 //supFan(conSpe(Ni=Modelica.Constants.inf)),
  ...
  Modelica.Blocks.Math.Gain freBas(k=60) "Frequency base"
...
public
  ...
  Modelica.Blocks.Interfaces.RealInput Vcs[1,2](final quantity="Voltage",
      final unit="V") "Supply voltage, complex number [1]: real, [2]:image, pu"
...
equation
  ...
  connect(filter.y, pro3[2].u1) annotation (Line(points={{391,70},{400,70},{400,
          44},{266,44},{266,-70},{352,-70},{352,-184},{358,-184}}, color={0,0,
          127}));
  connect(Vas[1, 1], pro1[1].u2) annotation (Line(points={{214,-340},{214,-260},
          {300,-260},{300,-116},{358,-116}}, color={0,0,127}));
  connect(Vas[1, 2], pro1[2].u2) annotation (Line(points={{214,-340},{214,-260},
          {300,-260},{300,-116},{358,-116}}, color={0,0,127}));
  connect(Vbs[1, 1], pro2[1].u2) annotation (Line(points={{260,-340},{260,-262},
          {302,-262},{302,-156},{358,-156}}, color={0,0,127}));
  connect(Vbs[1, 2], pro2[2].u2) annotation (Line(points={{260,-340},{260,-262},
          {302,-262},{302,-156},{358,-156}}, color={0,0,127}));
  connect(Vcs[1, 1], pro3[1].u2) annotation (Line(points={{300,-340},{300,-264},
          {304,-264},{304,-196},{358,-196}}, color={0,0,127}));
  connect(Vcs[1, 2], pro3[2].u2) annotation (Line(points={{300,-340},{300,-264},
          {304,-264},{304,-196},{358,-196}}, color={0,0,127}));
  annotation (
...
end Guideline36MotorExport_old;
