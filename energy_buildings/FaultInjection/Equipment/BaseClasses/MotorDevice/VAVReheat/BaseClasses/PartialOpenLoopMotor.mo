within FaultInjection.Equipment.BaseClasses.MotorDevice.VAVReheat.BaseClasses;
partial model PartialOpenLoopMotor
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  Buildings.Obsolete.Fluid.Sources.FixedBoundary sinHea(
    ...
    nPorts=1) "Sink for heating coil" annotation (Placement(transformation(
        ...
        rotation=90,
        origin={80,-122})));
  Buildings.Obsolete.Fluid.Sources.FixedBoundary sinCoo(
    redeclare package Medium = MediumW,
    p=300000,
    T=285.15,
...
public
  ...
  Buildings.Controls.OBC.CDL.Continuous.Product pro3[2]
    annotation (Placement(transformation(extent={{360,-200},{380,-180}})));
equation
