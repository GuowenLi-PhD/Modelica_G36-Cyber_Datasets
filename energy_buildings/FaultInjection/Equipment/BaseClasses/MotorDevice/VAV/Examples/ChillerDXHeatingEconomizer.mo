within FaultInjection.Equipment.BaseClasses.MotorDevice.VAV.Examples;
model ChillerDXHeatingEconomizer
  ...
  MotorDevice.VAV.ChillerDXHeatingEconomizer hvac(
  ...
  MotorDevice.VAV.Examples.BaseClasses.Room zon(mAir_flow_nominal=0.75,
  ...
  Modelica.Blocks.Sources.Constant vol(k=280) "Voltage"
...
equation
  ...
  connect(vol.y, hvac.V_rms) annotation (Line(points={{-139,110},{-108,110},{
          -108,50},{-56,50},{-56,15},{-42,15}}, color={0,0,127}));
  annotation (
    experiment(
      StopTime=504800,
      Interval=3600,
