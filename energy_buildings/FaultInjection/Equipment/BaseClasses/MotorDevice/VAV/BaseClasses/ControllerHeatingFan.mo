within FaultInjection.Equipment.BaseClasses.MotorDevice.VAV.BaseClasses;
model ControllerHeatingFan "Controller for heating and cooling"
  ...
  Buildings.Controls.Continuous.LimPID conHeaCoi(final k=kHea, controllerType=
        Modelica.Blocks.Types.SimpleController.P) "Controller for heating coil"
  ...
  Buildings.Controls.Continuous.LimPID conFan(
    ...
    final yMax=60,
    final yMin=60*minAirFlo)  "Controller for fan"
