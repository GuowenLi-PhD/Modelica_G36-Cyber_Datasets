...
model FoulingDryCoilEffectivenessNTU
  "Heat exchanger with effectiveness - NTU relation and no moisture condensation"
  extends FaultInjection.Equipment.ParameterFaults.BaseClasses.PartialEffectivenessNTU(
...
end FoulingDryCoilEffectivenessNTU;
