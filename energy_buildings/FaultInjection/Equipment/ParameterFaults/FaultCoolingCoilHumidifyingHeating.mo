...
model FaultCoolingCoilHumidifyingHeating
  extends
    FaultInjection.Equipment.ParameterFaults.BaseClasses.FaultWetCoilCounterFlowStoreStateVariables.FaultPartialCoolingCoilHumidifyingHeating(
...
end FaultCoolingCoilHumidifyingHeating;
