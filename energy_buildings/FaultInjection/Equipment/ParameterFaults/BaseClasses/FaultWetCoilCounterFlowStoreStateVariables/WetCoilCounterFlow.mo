...
model WetCoilCounterFlow
  ...
  extends
    FaultInjection.Equipment.ParameterFaults.BaseClasses.FaultWetCoilCounterFlowStoreStateVariables.DryCoilCounterFlow(
    redeclare replaceable package Medium2 =
        Modelica.Media.Interfaces.PartialCondensingGases,
    redeclare final model HexElement =
        FaultInjection.Equipment.ParameterFaults.BaseClasses.FaultWetCoilCounterFlowStoreStateVariables.HexElementLatent,
    ele(
      iniTmas={iniTmas[i] for i in 1:nEle},
      inider_Tmas={inider_Tmas[i] for i in 1:nEle},
      inip_w={inip_w[i] for i in 1:nEle},
      inix_w={inix_w[i] for i in 1:nEle}));
