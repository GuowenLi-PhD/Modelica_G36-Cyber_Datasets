...
partial model FaultPartialCoolingCoilHumidifyingHeating
  "Partial AHU model"
  ...
  FaultInjection.Equipment.ParameterFaults.FoulingWetCoilCounterFlow cooCoi(
...
end FaultPartialCoolingCoilHumidifyingHeating;
