...
model FaultElectricChillerEIR "Electric chiller based on the DOE-2.1 model"
  extends FaultInjection.Equipment.VariableFaults.BaseClasses.PartialElectric(
  ...
  final TEvaLvg_nominal= per.TEvaLvg_nominal,
    FIR(y=1 + chiFauMod.fauIntRat*(chiFauMod.perChiFau_c1456[1] + chiFauMod.perChiFau_c23
          [1]*TEvaLvg + chiFauMod.perChiFau_c23[2]*TConEnt + chiFauMod.perChiFau_c1456
          [2]*QEva_flow/QEva_flow_nominal)^2 + chiFauMod.perChiFau_c1456[3]*
          QEva_flow/QEva_flow_nominal*chiFauMod.fauIntRat + chiFauMod.perChiFau_c1456
          [4]*chiFauMod.fauIntRat));
