...
model FaultMixingBox "Outside air mixing box with non-interlocked air dampers"
  ...
  FaultInjection.Equipment.VariableFaults.StuckDamperExponential damOut(
 ...
 parameter Utilities.InsertionTypes.Generic.faultMode faultMode
    annotation (Dialog(group="Fault Parameters"),Placement(transformation(extent={{-40,80},{-20,100}})));
...
equation
  ...
  connect(yOut, damOut.y)
    annotation (Line(points={{0,120},{0,71.8}}, color={0,0,127}));
