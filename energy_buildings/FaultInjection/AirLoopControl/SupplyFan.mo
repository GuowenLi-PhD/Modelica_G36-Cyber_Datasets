within FaultInjection.AirLoopControl;
block SupplyFan "Block to control multi zone VAV AHU supply fan"
  ...
  Utilities.Overwrite.OverwriteVariable oveDifPreSupFan(description=
        "Supply air differential pressure setpoint", u(
      unit="Pa",
      min=25,
      max=400)) "Overwrite supply air duct differential pressure setpoint"
...
equation
  ...
  connect(firOrdHol.y, oveDifPreSupFan.u) annotation (Line(points={{-78,-50},{-76,
          -50},{-76,-42},{-72,-42}}, color={0,0,127}));
  connect(oveDifPreSupFan.y, norPSet.u1) annotation (Line(points={{-49,-42},{-44,
          -42},{-44,-54},{-76,-54},{-76,-64},{-72,-64}}, color={0,0,127}));
annotation (
