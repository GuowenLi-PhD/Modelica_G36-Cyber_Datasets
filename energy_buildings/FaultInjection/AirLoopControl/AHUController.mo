...
block AHUController
  ...
  Utilities.Overwrite.OverwriteVariable oveTSupAir(description=
        "Supply air temperature setpoint", u(
      unit="K",
      min=273.15 + 0,
      max=273.15 + 60)) "Overwrite supply air temperature setpoint"
...
equation
  ...
  connect(supTemSetPoi.TSupSet, oveTSupAir.u)
    annotation (Line(points={{22,180},{38,180}}, color={0,0,127}));
  connect(oveTSupAir.y, TSupSet)
    annotation (Line(points={{61,180},{220,180}}, color={0,0,127}));
  connect(oveTSupAir.y, val.TSupSet) annotation (Line(points={{61,180},{72,180},
