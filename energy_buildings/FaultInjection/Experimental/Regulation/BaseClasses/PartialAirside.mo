within FaultInjection.Experimental.Regulation.BaseClasses;
partial model PartialAirside
  "Variable air volume flow system with terminal reheat and five thermal zones"
  extends
    FaultInjection.Experimental.Regulation.BaseClasses.PartialPhysicalAirside(
  ...
  Modelica.Blocks.Interfaces.RealInput s
    "Delta speed imposed on fan speed controller for frequency regulation"
  ...
  Modelica.Blocks.Interfaces.RealOutput PFan "Electrical power consumed"
    annotation (Placement(transformation(extent={{1388,-36},{1408,-16}})));
equation
  ...
  connect(freSta.y, andFreSta.u1) annotation (Line(points={{22,-92},{28,-92},{
          28,-112},{-40,-112},{-40,-130},{-22,-130}},
                                                 color={255,0,255}));
  connect(lim.y, fanSup.y) annotation (Line(points={{411,10},{420,10},{420,-14},
          {310,-14},{310,-28}}, color={0,0,127}));
  connect(lim.u, s) annotation (Line(points={{388,10},{366,10},{366,20},{-340,
          20},{-340,30},{-380,30}}, color={0,0,127}));
  connect(fanSup.P, PFan) annotation (Line(points={{321,-31},{324,-31},{324,-26},
          {1398,-26}}, color={0,0,127}));
  annotation (
