...
partial model PartialWaterside
 ...
 // WSE parameters
  ...
  parameter FaultInjection.Experimental.Regulation.Data.Chiller[numChi] perChi(
  ...
  Controls.ChillerStage chiStaCon(tWai=0) "Chiller staging control"
  ...
  Modelica.Blocks.Math.IntegerToBoolean intToBoo(threshold=Integer(
  ...
  Controls.ConstantSpeedPumpStage CWPumCon(tWai=0)
  ...
  Controls.CoolingTowerSpeed cooTowSpeCon(
  ...
  Controls.TemperatureDifferentialPressureReset
    temDifPreRes(
