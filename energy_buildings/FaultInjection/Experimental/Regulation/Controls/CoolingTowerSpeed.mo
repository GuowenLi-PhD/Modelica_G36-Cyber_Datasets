...
model CoolingTowerSpeed "Controller for the fan speed in cooling towers"
  ...
  Modelica.Blocks.Sources.BooleanExpression pmcMod(
    y= cooMod == Integer(FaultInjection.Experimental.Regulation.Types.CoolingModes.PartialMechanical))
  ...
  Modelica.Blocks.Math.IntegerToBoolean fmcMod(threshold=Integer(FaultInjection.Experimental.Regulation.Types.CoolingModes.FullMechanical))
    "Fully mechanical cooling mode"
    annotation (Placement(transformation(extent={{-90,30},{-70,50}})));

  Modelica.Blocks.Sources.BooleanExpression offMod(y=cooMod == Integer(
        FaultInjection.Experimental.Regulation.Types.CoolingModes.Off))
