...
model CoolingMode
  ...
  Modelica.Blocks.MathInteger.MultiSwitch swi(
    y_default=0,
    expr={Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.FreeCooling),
        Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.PartialMechanical),
        Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.FullMechanical),
        Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.Off)},
    nu=4)
