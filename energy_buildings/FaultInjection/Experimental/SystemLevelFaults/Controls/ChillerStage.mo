...
model ChillerStage "Chiller staging control logic"
  ...
  Modelica.StateGraph.Transition con1(
    ...
    condition=cooMod > Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.FreeCooling)
         and cooMod < Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.Off))
  ...
  Modelica.StateGraph.Transition con4(
    ...
    waitTime=tWai,
    condition=cooMod == Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.FreeCooling)
         or cooMod == Integer(FaultInjection.Experimental.SystemLevelFaults.Types.CoolingModes.Off))
