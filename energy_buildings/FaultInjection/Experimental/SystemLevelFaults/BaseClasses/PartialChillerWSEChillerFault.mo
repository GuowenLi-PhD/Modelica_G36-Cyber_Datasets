...
partial model PartialChillerWSEChillerFault
  ...
  FaultInjection.Equipment.VariableFaults.FaultElectricChillerParallel chiPar(
  ...
  parameter Utilities.InsertionTypes.Generic.ChillerFaultMode chiFauMod[numChi]
    "Chiller fault mode"
    annotation (Dialog(group="Chiller"),Placement(transformation(extent={{8,78},{28,98}})));
initial equation
...
end PartialChillerWSEChillerFault;
