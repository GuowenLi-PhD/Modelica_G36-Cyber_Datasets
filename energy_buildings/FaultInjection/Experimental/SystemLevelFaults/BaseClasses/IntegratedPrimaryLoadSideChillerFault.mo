...
model IntegratedPrimaryLoadSideChillerFault
  "Integrated water-side economizer on the load side in a primary-only chilled water system"
  extends
    FaultInjection.Experimental.SystemLevelFaults.BaseClasses.PartialIntegratedPrimaryChillerFault(
    final m_flow_nominal={m1_flow_chi_nominal,m2_flow_chi_nominal,m1_flow_wse_nominal,
      m2_flow_chi_nominal,numChi*m2_flow_chi_nominal,m2_flow_wse_nominal,numChi*m2_flow_chi_nominal},
...
end IntegratedPrimaryLoadSideChillerFault;
