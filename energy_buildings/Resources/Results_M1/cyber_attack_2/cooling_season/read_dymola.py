...
res_attack=Reader('SignalBlockingDymola.mat','dymola')
...
# attacked system
t_attack,TCHWSet_orig_attack = res_attack.values('temDifPreRes.TSet')
t_attack,TCHWSet_corr_attack = res_attack.values('chiWSE.TSet')
