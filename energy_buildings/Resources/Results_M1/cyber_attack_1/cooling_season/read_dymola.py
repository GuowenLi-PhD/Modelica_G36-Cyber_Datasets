...
t_base,TZonResReq_base = res_base.values('TZonResReq.y')
...
# attacked system
t_attack,TZonResReq_orig_attack = res_attack.values('TZonResReq.y')
t_attack,TZonResReq_corr_attack = res_attack.values('conAHU.uZonTemResReq')
...
fig.add_subplot(521)
plt.plot(np.array(t_base),np.array(TZonResReq_base),'b--',markevery=0.1,marker="o",markersize=3,linewidth=1) #
