...
model SimpleRC_Parameter
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor res(R=oveParR.p)
  ...
  FaultInjection.Utilities.SignalExchange.OverwriteParameter oveParR(p(
      min=0,
      max=100,
      unit="K/W") = 0.01, description="R Value")
...
equation
  ...
  annotation (uses(Modelica(version="3.2.2"), IBPSA(version="3.0.0"),
      FaultInjection(version="1.0.0")), experiment(StopTime=172800,
        __Dymola_Algorithm="Dassl"));
end SimpleRC_Parameter;
