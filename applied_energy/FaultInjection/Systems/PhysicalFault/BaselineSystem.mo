...
model BaselineSystem "System example for fault injection"
  ...
  extends FaultInjection.Systems.PhysicalFault.BaseClasses.PartialHotWaterside(
  ...
  extends FaultInjection.Systems.PhysicalFault.BaseClasses.PartialAirside(
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
  ...
  extends FaultInjection.Systems.PhysicalFault.BaseClasses.PartialWaterside(
    redeclare
    ...
    chiFauMod(
      each perChiFau_c23={-0.01228,0.04126},
      each perChiFau_c1456={-8.854,0.2838,0.1807,0},
      each fauIntRat=0.4));
...
experiment(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/dymola/Systems/PhysicalFaults/BaselineSystem.mos"
        "Simulate and Plot"));
end BaselineSystem;
