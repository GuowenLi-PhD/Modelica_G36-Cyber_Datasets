...
model BaselineSystem "System example for fault injection"
  ...
  extends
    FaultInjection.Systems.PhysicalFaultHeating.BaseClasses.PartialHotWaterside(
    final Q_flow_boi_nominal=designHeatLoad,
    minFloBypHW(k=0.1),
    pumSpeHW(
      k=0.5, reset=Buildings.Types.Reset.Parameter, y_reset=0),
    boiTSup(
      Ti=60,
      y_start=0,
  ...
  extends
    FaultInjection.Systems.PhysicalFaultHeating.BaseClasses.PartialAirside(
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
  ...
  extends
    FaultInjection.Systems.PhysicalFaultHeating.BaseClasses.PartialWaterside(
    redeclare
...
experiment(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/dymola/Systems/PhysicalFaultsHeating/BaselineSystem.mos"
        "Simulate and Plot"));
end BaselineSystem;
