...
model BaselineSystem "System example for fault injection"
  ...
  extends
    FaultInjection.Systems.PhysicalFaultShoulder.BaseClasses.PartialHotWaterside(
  ...
  extends
    FaultInjection.Systems.PhysicalFaultShoulder.BaseClasses.PartialAirside(
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
  ...
  extends
    FaultInjection.Systems.PhysicalFaultShoulder.BaseClasses.PartialWaterside(
    redeclare
  ...
  Experimental.SystemLevelFaults.Controls.CoolingMode cooModCon(
    tWai=1200,
    deaBan1=1.1,
    deaBan2=0.5,
    deaBan3=1.1,
  ...
  Experimental.SystemLevelFaults.Controls.PlantRequest plaReqChi
    annotation (Placement(transformation(extent={{1044,-120},{1064,-100}})));
  Experimental.SystemLevelFaults.Controls.ChillerPlantEnableDisable chiPlaEnaDis(
      yFanSpeMin=0.15,                                                           plaReqTim=
       30*60)
  ...
  Experimental.SystemLevelFaults.Controls.BoilerPlantEnableDisable boiPlaEnaDis(
    yFanSpeMin=0.15,
    plaReqTim=30*60,
    tWai=10*60,
    TOutPla=291.15)
  ...
  Experimental.SystemLevelFaults.Controls.PlantRequest plaReqBoi
...
equation
  ...
  connect(proCHWVal.u1, conAHU.yCoo) annotation (Line(points={{410,-198},{384,
          -198},{384,42},{446,42},{446,544},{424,544}}, color={0,0,127}));
  ...
  connect(watVal.y_actual, temDifPreRes.u) annotation (Line(points={{530.8,-113},
          {530.8,-232},{874,-232},{874,-336},{1170,-336},{1170,-244},{1194,-244}},
        color={0,0,127}));
...
experiment(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/dymola/Systems/PhysicalFaultsShoulder/BaselineSystem.mos"
        "Simulate and Plot"));
end BaselineSystem;
