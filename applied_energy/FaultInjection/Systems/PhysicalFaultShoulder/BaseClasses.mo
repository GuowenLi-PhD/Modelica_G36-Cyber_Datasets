  ...
  partial model PartialWaterside
   ...
   // WSE parameters
    ...
    parameter Utilities.InsertionTypes.Generic.faultMode faultCoiVavStu
      ...
      annotation (Placement(transformation(extent={{504,-146},{524,-126}})));
  equation
...
First implementation.
  ...
  //    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
    ...
    Experimental.VAVReheat.ThermalZones.Floor flo(
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">issue 426</a>.
  ...
  partial model PartialAirside
    ...
    extends
      FaultInjection.Systems.PhysicalFaultShoulder.BaseClasses.PartialPhysicalAirside(
