...
model BaselineSystem "System example for fault injection"
  ...
  extends FaultInjection.Systems.CyberAttack.BaseClasses.PartialHotWaterside(
  ...
  extends FaultInjection.Systems.CyberAttack.BaseClasses.PartialAirside(
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
  ...
  extends FaultInjection.Systems.CyberAttack.BaseClasses.PartialWaterside(
    redeclare
  ...
  extends FaultInjection.Systems.CyberAttack.BaseClasses.EnergyMeter(
 ...
 extends FaultInjection.Systems.CyberAttack.BaseClasses.RunTime;
