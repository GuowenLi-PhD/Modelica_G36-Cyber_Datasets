...
partial model PartialWaterside
 ...
 // WSE parameters
  ...
  Experimental.SystemLevelFaults.Controls.TemperatureDifferentialPressureReset temDifPreRes(
  ...
  Utilities.InsertionTypes.Variables.SignalDelay.RealFixedDelay CHWSTDelAtt(faultMode=
       faultCHWTSet, delayTime=1800)          "CHWST delay attack"
    annotation (Placement(transformation(extent={{1218,-310},{1198,-290}})));
  parameter Utilities.InsertionTypes.Generic.faultMode faultCHWTSet(
  ...
  Utilities.InsertionTypes.Variables.SignalCorruption.External chiOnAtt(faultMode=
       faultChiOn)
  ...
  parameter Utilities.InsertionTypes.Generic.faultMode faultChiOn(
