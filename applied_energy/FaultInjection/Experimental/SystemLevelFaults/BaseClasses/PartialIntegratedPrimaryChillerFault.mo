...
model PartialIntegratedPrimaryChillerFault
  "Integrated water-side economizer for primary-only chilled water system"
  extends
    FaultInjection.Experimental.SystemLevelFaults.BaseClasses.PartialChillerWSEChillerFault(
    final numVal=7);
...
end PartialIntegratedPrimaryChillerFault;
