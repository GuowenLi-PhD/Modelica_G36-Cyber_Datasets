within FaultInjection.Experimental.SystemLevelFaults.WaterSide;
model IntegratedPrimaryLoadSideEconomizer
  ...
  extends
    FaultInjection.Experimental.SystemLevelFaults.WaterSide.BaseClasses.PostProcess(
  ...
  extends
    FaultInjection.Experimental.SystemLevelFaults.WaterSide.BaseClasses.PartialDataCenter(
      redeclare
      Buildings.Applications.DataCenters.ChillerCooled.Equipment.IntegratedPrimaryLoadSide
      chiWSE(addPowerToMedium=false, perPum=perPumPri), weaData(filNam=
