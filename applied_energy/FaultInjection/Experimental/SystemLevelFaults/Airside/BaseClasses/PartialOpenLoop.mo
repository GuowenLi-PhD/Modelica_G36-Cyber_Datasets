within FaultInjection.Experimental.SystemLevelFaults.Airside.BaseClasses;
...
//    "Nominal capacity of heating coil";
  ...
  FaultInjection.Experimental.SystemLevelFaults.Airside.ThermalZones.VAVBranch cor(
  ...
  FaultInjection.Experimental.SystemLevelFaults.Airside.ThermalZones.VAVBranch sou(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  FaultInjection.Experimental.SystemLevelFaults.Airside.ThermalZones.VAVBranch eas(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  FaultInjection.Experimental.SystemLevelFaults.Airside.ThermalZones.VAVBranch nor(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  FaultInjection.Experimental.SystemLevelFaults.Airside.ThermalZones.VAVBranch wes(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  Buildings.Fluid.Sensors.VolumeFlowRate VSupWes_flow(
    ...
    allowFlowReversal=allowFlowReversal) "Discharge air flow rate" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={1300,128})));
  FaultInjection.Experimental.SystemLevelFaults.Airside.BaseClasses.MixingBox eco(
    redeclare package Medium = MediumA,
