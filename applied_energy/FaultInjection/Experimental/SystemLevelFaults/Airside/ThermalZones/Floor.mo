within FaultInjection.Experimental.SystemLevelFaults.Airside.ThermalZones;
model Floor "Model of a floor of the building"
  ...
  Modelica.Blocks.Math.Gain gaiIntCor[3](each k=1)
    "Gain for internal heat gain amplification for core zone"
...
equation
  ...
  connect(gaiIntSou.y, sou.qGai_flow) annotation (Line(
      ...
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(gai.y, gaiIntCor.u) annotation (Line(points={{-79,110},{-72,110},{-72,
          80},{-62,80}}, color={0,0,127}));
  connect(gaiIntCor.y, cor.qGai_flow) annotation (Line(
      points={{-39,80},{-20,80},{-20,110},{126,110},{126,64},{142.4,64}},
      color={0,0,127},
      pattern=LinePattern.Dash));
