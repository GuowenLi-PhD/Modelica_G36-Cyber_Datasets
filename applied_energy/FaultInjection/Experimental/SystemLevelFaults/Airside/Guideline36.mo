within FaultInjection.Experimental.SystemLevelFaults.Airside;
model Guideline36
  "Variable air volume flow system with terminal reheat and five thermal zones"
  extends Modelica.Icons.Example;
  extends
    FaultInjection.Experimental.SystemLevelFaults.Airside.BaseClasses.PartialOpenLoop;
...
equation
  ...
  connect(conVAVCor.TZonHeaSet, TZonSet.TZonHeaSet[1]) annotation (Line(points={{528,52},
          {480,52},{480,310},{82,310}},           color={0,0,127}));
  connect(conVAVCor.TZonCooSet, TZonSet.TZonCooSet[1]) annotation (Line(points={{528,50},
          {480,50},{480,317},{82,317}},           color={0,0,127}));
  connect(conVAVSou.TZonHeaSet, TZonSet.TZonHeaSet[2]) annotation (Line(points={{698,50},
          {660,50},{660,310},{82,310}},           color={0,0,127}));
  connect(conVAVSou.TZonCooSet, TZonSet.TZonCooSet[2]) annotation (Line(points={{698,48},
          {660,48},{660,317},{82,317}},           color={0,0,127}));
  connect(conVAVEas.TZonHeaSet, TZonSet.TZonHeaSet[3]) annotation (Line(points={{878,50},
          {850,50},{850,310},{82,310}},           color={0,0,127}));
  connect(conVAVEas.TZonCooSet, TZonSet.TZonCooSet[3]) annotation (Line(points={{878,48},
          {850,48},{850,317},{82,317}},           color={0,0,127}));
  connect(conVAVNor.TZonHeaSet, TZonSet.TZonHeaSet[4]) annotation (Line(points={{1038,50},
          {1020,50},{1020,310},{82,310}},            color={0,0,127}));
  connect(conVAVNor.TZonCooSet, TZonSet.TZonCooSet[4]) annotation (Line(points={{1038,48},
          {1020,48},{1020,317},{82,317}},            color={0,0,127}));
  connect(conVAVWes.TZonHeaSet, TZonSet.TZonHeaSet[5]) annotation (Line(points={{1238,48},
          {1202,48},{1202,310},{82,310}},            color={0,0,127}));
  connect(conVAVWes.TZonCooSet, TZonSet.TZonCooSet[5]) annotation (Line(points={{1238,46},
          {1202,46},{1202,317},{82,317}},            color={0,0,127}));
  ...
  connect(TZonSet.uOcc, occSch.occupied) annotation (Line(points={{58,316.025},
          {-92,316.025},{-92,300},{-240,300},{-240,-216},{-297,-216}},color={
          255,0,255}));
  connect(occSch.tNexOcc, TZonSet.tNexOcc) annotation (Line(points={{-297,-204},
          {-254,-204},{-254,319},{58,319}}, color={0,0,127}));
  connect(TZonSet.TZon, flo.TRooAir) annotation (Line(points={{58,313},{46,313},
          {46,628},{1164,628},{1164,491.333},{1094.14,491.333}},          color=
         {0,0,127}));
  connect(conAHU.TZonHeaSet, TZonSet.TZonHeaSet[1]) annotation (Line(points={{382,467},
          {110,467},{110,310},{82,310}},          color={0,0,127}));
  connect(conAHU.TZonCooSet, TZonSet.TZonCooSet[1]) annotation (Line(points={{382,
          462.5},{120,462.5},{120,317},{82,317}}, color={0,0,127}));
  connect(conAHU.TZon, flo.TRooAir) annotation (Line(points={{383,452},{280,452},
          {280,622},{1164,622},{1164,491.333},{1094.14,491.333}},
        color={0,0,127}));
  connect(conAHU.TOut, TOut.y) annotation (Line(points={{382,458},{-266,458},{
          -266,180},{-279,180}},           color={0,0,127}));
  connect(TRet.T, conAHU.TOutCut) annotation (Line(points={{100,151},{100,404},
          {382,404}},                  color={0,0,127}));
  connect(conAHU.TSup, TSup.T) annotation (Line(points={{382,408.5},{152,408.5},
          {152,-20},{340,-20},{340,-29}},          color={0,0,127}));
  connect(dpDisSupFan.p_rel, conAHU.ducStaPre) annotation (Line(points={{311,0},
          {160,0},{160,453.5},{382,453.5}},         color={0,0,127}));
  connect(conAHU.uOpeMod, TZonSet.yOpeMod) annotation (Line(points={{382,378.5},
          {130,378.5},{130,303},{82,303}},            color={255,127,0}));
  ...
  connect(conVAVCor.uOpeMod, TZonSet.yOpeMod) annotation (Line(points={{528,32},
          {520,32},{520,16},{420,16},{420,200},{130,200},{130,303},{82,303}},
        color={255,127,0}));
  connect(conVAVSou.uOpeMod, TZonSet.yOpeMod) annotation (Line(points={{698,30},
          {690,30},{690,16},{420,16},{420,200},{130,200},{130,303},{82,303}},
        color={255,127,0}));
  connect(conVAVEas.uOpeMod, TZonSet.yOpeMod) annotation (Line(points={{878,30},
          {868,30},{868,16},{420,16},{420,200},{130,200},{130,303},{82,303}},
        color={255,127,0}));
  connect(conVAVNor.uOpeMod, TZonSet.yOpeMod) annotation (Line(points={{1038,30},
          {1032,30},{1032,16},{420,16},{420,200},{130,200},{130,303},{82,303}},
        color={255,127,0}));
  connect(conVAVWes.uOpeMod, TZonSet.yOpeMod) annotation (Line(points={{1238,28},
          {1228,28},{1228,16},{420,16},{420,200},{130,200},{130,303},{82,303}},
        color={255,127,0}));
  connect(conAHU.uZonTemResReq, TZonResReq.y) annotation (Line(points={{382,374},
          {352,374},{352,360},{322,360}},                color={255,127,0}));
  ...
  connect(conAHU.uZonPreResReq, PZonResReq.y) annotation (Line(points={{382,
          369.5},{360,369.5},{360,330},{322,330}},       color={255,127,0}));
  ...
  connect(conAHU.yOutDamPos, eco.yOut) annotation (Line(points={{426,371},{450,
          371},{450,36},{-10,36},{-10,-34}},                   color={0,0,127}));
  ...
  connect(VOut1.V_flow, conAHU.VOut_flow) annotation (Line(points={{-61,-20.9},
          {-61,390.5},{382,390.5}},        color={0,0,127}));
  connect(fanSup.y, conAHU.ySupFanSpe) annotation (Line(points={{310,-28},{310,
          -14},{460,-14},{460,452},{426,452}},             color={0,0,127}));
  connect(conAHU.yCoo, gaiCooCoi.u) annotation (Line(points={{426,389},{446,389},
          {446,-274},{88,-274},{88,-248},{98,-248}},              color={0,0,
          127}));
  connect(conAHU.TMix, TMix.T) annotation (Line(points={{382,384.5},{40,384.5},
          {40,-29}},color={0,0,127}));
  connect(conAHU.yRetDamPos, eco.yRet) annotation (Line(points={{426,380},{436,
          380},{436,40},{-16.8,40},{-16.8,-34}},                   color={0,0,
          127}));
  connect(yOutDam.y, eco.yExh)
    annotation (Line(points={{-18,-10},{-3,-10},{-3,-34}}, color={0,0,127}));
  connect(conAHU.yHea, swiFreSta.u3) annotation (Line(points={{426,398},{458,
          398},{458,-280},{48,-280},{48,-200},{58,-200}},          color={0,0,
          127}));
