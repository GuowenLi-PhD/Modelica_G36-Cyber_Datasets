within FaultInjection.Experimental.SystemLevelFaults.Airside.Controls.Examples;
model OperationModes "Test model for operation modes"
    extends Modelica.Icons.Example;
  import ModelicaVAV = FaultInjection.Experimental.SystemLevelFaults.Airside;
