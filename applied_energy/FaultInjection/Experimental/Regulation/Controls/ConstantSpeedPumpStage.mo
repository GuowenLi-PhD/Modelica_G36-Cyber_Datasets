...
model ConstantSpeedPumpStage "Staging control for constant speed pumps"
  ...
  Modelica.StateGraph.Transition con1(
    ...
    condition=cooMod == Integer(FaultInjection.Experimental.Regulation.Types.CoolingModes.FreeCooling)
         or cooMod == Integer(FaultInjection.Experimental.Regulation.Types.CoolingModes.PartialMechanical)
         or cooMod == Integer(FaultInjection.Experimental.Regulation.Types.CoolingModes.FullMechanical))
  ...
  Modelica.StateGraph.Transition con3(
    enableTimer=true,
    waitTime=tWai,
    condition=cooMod == Integer(FaultInjection.Experimental.Regulation.Types.CoolingModes.FullMechanical)
    and numOnChi < 2)
  ...
  Modelica.StateGraph.Transition con4(
    enableTimer=true,
    waitTime=tWai,
    condition=cooMod == Integer(FaultInjection.Experimental.Regulation.Types.CoolingModes.Off))
