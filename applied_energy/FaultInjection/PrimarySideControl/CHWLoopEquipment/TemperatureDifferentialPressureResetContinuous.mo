...
model TemperatureDifferentialPressureResetContinuous
  ...
  BaseClasses.TrimAndRespondContinuousTimeApproximation
                             triAndRes(uTri=uTri)
  ...
  Buildings.Controls.OBC.CDL.Integers.GreaterThreshold intGreThr(threshold=
        Integer(WSEControlLogics.Controls.WSEControls.Type.OperationModes.FreeCooling))
...
equation
  ...
  connect(intGreThr.y, swi1.u2) annotation (Line(points={{-39,60},{50,60},{50,
          80},{58,80}}, color={255,0,255}));
  connect(intGreThr.y, swi2.u2) annotation (Line(points={{-39,60},{50,60},{50,
...
end TemperatureDifferentialPressureResetContinuous;
