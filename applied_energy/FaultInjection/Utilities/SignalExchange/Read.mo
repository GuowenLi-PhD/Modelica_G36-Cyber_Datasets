...
model Read "Block that allows a signal to be read as an FMU output"
  ...
  parameter String zone = "1" if (KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.AirZoneTemperature
     or KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.RadiativeZoneTemperature
     or KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.OperativeZoneTemperature
     or KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.RelativeHumidity
     or KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.CO2Concentration)
    ...
    or CO2Concentration"
  annotation(Dialog(enable=(KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.AirZoneTemperature
           or KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.RadiativeZoneTemperature
           or KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.OperativeZoneTemperature
           or KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.RelativeHumidity
           or KPIs == FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.CO2Concentration)));
