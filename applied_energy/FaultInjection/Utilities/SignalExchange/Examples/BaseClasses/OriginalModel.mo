within FaultInjection.Utilities.SignalExchange.Examples.BaseClasses;
model OriginalModel "Original model"
  ...
  OverwriteVariable oveWriSet(description="First order system control setpoint",
      u(
      min=-10,
      max=10,
  ...
  OverwriteVariable oveWriAct(description="First order system input", u(
      min=-10,
      max=10,
  ...
  Read rea(
    ...
    KPIs=FaultInjection.Utilities.SignalExchange.SignalTypes.SignalsForKPIs.None)
