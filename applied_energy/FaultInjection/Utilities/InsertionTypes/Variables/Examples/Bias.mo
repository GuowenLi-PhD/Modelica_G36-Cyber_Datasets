...
model Bias "Example to test bias"
  extends Modelica.Icons.Example;

  FaultInjection.Utilities.InsertionTypes.Variables.Bias bias(faultMode=
        faultMode)
...
equation
  connect(con.y, bias.u)
    annotation (Line(points={{-59,0},{-14,0}}, color={0,0,127}));
  connect(noi.y, bias.uFau_in) annotation (Line(points={{-59,40},{-38,40},{
          -38,8},{-14,8}}, color={0,0,127}));
