...
model FaultPassReal
  "Block that passes real faulty signal when triggerred"
  ...
  parameter Real u_f= 0  "Fault signal"
  ...
  FaultInjection.Utilities.InsertionTypes.Interfaces.RealInput u_f_in if  use_u_f_in
...
protected
    FaultInjection.Utilities.InsertionTypes.Interfaces.RealInput u_f_in_internal
...
equation
  ...
  connect(u_f_in_internal,swi.u1);

  connect(swi.u3,u)  annotation (Line(points={{-12,-8},{-60,-8},{-60,0},{-120,0}},
               color={0,0,127}));
  connect(swi.y,y)
    annotation (Line(points={{11,0},{110,0}}, color={0,0,127}));
  connect(swi.u2, trigger) annotation (Line(points={{-12,0},{-40,0},{-40,40},{-120,
          40}}, color={255,0,255}));
