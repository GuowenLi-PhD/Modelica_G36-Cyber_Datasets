...
partial model PartialFaultInjectionInteger
  ...
  FaultInjection.Utilities.InsertionTypes.Variables.BaseClass.FaultPassInteger fauPas(use_u_f_in=true)
...
end PartialFaultInjectionInteger;
