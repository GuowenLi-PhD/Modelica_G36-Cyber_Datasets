...
model Signal "Example to inject faults to signal"
  ...
  FaultInjection.Utilities.InsertionTypes.Variables.BaseClass.Signal
    fauSig(use_uFau_in=true)
...
equation
  ...
  connect(senTem.T, fauSig.u)
    annotation (Line(points={{26,11},{26,40},{48,40}}, color={0,0,127}));
  connect(booSte.y, fauSig.triFau) annotation (Line(points={{-59,40},{26,40},{26,
          44},{48,44}}, color={255,0,255}));
  connect(fau.y, fauSig.uFau_in) annotation (Line(points={{-59,70},{26,70},{26,48},
          {48,48}}, color={0,0,127}));
