within FaultInjection.SystemIBPSA.CyberAttack;
model BaselineSystem "System example for fault injection"
  extends Modelica.Icons.Example;
  extends
    FaultInjection.SystemIBPSA.CyberAttack.BaseClasses.PartialHotWaterside(
  ...
  extends FaultInjection.SystemIBPSA.CyberAttack.BaseClasses.PartialAirside(
    fanSup(show_T=false),
    conAHU(
      pNumIgnReq=1,
      TSupSetMin=284.95,
    ...
    flo(
      ...
      TCooOn=oveTCooOn.p);
  extends FaultInjection.SystemIBPSA.CyberAttack.BaseClasses.PartialWaterside(
    redeclare
  ...
  extends FaultInjection.SystemIBPSA.CyberAttack.BaseClasses.EnergyMeter(
 ...
 extends FaultInjection.SystemIBPSA.CyberAttack.BaseClasses.RunTime;
  ...
  Utilities.SignalExchange.OverwriteParameter oveTCooOn(p(
      unit="K",
      min=273.15 + 20,
      max=273.15 + 28) = 273.15 + 24, description="Zone temperature setpoint during cooling on")
...
equation
  ...
  connect(chiStaCon.y, chiRunTim.u) annotation (Line(points={{1307,-128},{1316,
          -128},{1316,-110},{1370,-110},{1370,460},{1320,460},{1320,640},{1338,
          640}}, color={0,0,127}));
  ...
  connect(conAHU.ySupFanSpe, fanSup.y) annotation (Line(points={{424,618.667},{
          454,618.667},{454,-18},{310,-18},{310,-28}}, color={0,0,127}));
  annotation (
