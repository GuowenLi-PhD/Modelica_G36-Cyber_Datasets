...
partial model PartialAirside
  ...
  extends
    FaultInjection.SystemIBPSA.CyberAttack.BaseClasses.PartialPhysicalAirside(
  ...
  Utilities.SignalExchange.OverwriteVariable
                                     oveTZonResReq(
    u(unit = "1",
      min = 0,
      max = 20),
    description="Zone temperature reset request numbers")
...
equation
  ...
  connect(flo.TRooAir, TZonSet.TZon) annotation (Line(points={{1094.14,491.333},
          {1164,491.333},{1164,660},{44,660},{44,313},{58,313}}, color={0,0,127}));
  annotation (
