...
model FaultTemperatureSensor "Temperature sensor with faults"
  ...
  Utilities.InsertionTypes.Variables.SignalCorruption.Additive
                                          bia(faultMode=faultMode, use_uFau_in=
        true)                                                      "Bias"
...
equation
  ...
  connect(senTem.T, bia.u) annotation (Line(points={{0,11},{0,28},{-60,28},{-60,
          50},{-42,50}}, color={0,0,127}));
  connect(bia.y, T)
    annotation (Line(points={{-19,50},{0,50},{0,110}}, color={0,0,127}));
  connect(bia.uFau_in, uFau_in) annotation (Line(points={{-42,56},{-60,56},{-60,
