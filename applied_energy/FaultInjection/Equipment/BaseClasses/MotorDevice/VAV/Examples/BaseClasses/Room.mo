within FaultInjection.Equipment.BaseClasses.MotorDevice.VAV.Examples.BaseClasses;
model Room
  ...
  MotorDevice.VAV.Examples.BaseClasses.InternalLoads intLoad
    "Internal loads" annotation (Placement(transformation(extent={{-120,
            150},{-100,170}})));
protected
