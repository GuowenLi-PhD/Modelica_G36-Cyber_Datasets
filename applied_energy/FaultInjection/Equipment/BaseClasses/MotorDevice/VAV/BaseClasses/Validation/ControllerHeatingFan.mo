within FaultInjection.Equipment.BaseClasses.MotorDevice.VAV.BaseClasses.Validation;
model ControllerHeatingFan "Validate the block ControllerHeatingFan"
  extends Modelica.Icons.Example;

  MotorDevice.VAV.BaseClasses.ControllerHeatingFan conHeaFan(minAirFlo=
        0.6) "Controller for heating and cooling"
