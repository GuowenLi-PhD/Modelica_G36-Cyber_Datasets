...
model Guideline36MotorSampler
  "Variable air volume flow system with terminal reheat and five thermal zones"
  extends Modelica.Icons.Example;
  extends MotorDevice.VAVReheat.BaseClasses.PartialOpenLoopMotor(
    fanSup(R_r=0.65),
    flo(gai(K=20*[0.4; 0.4; 0.2])),
    cooCoi(
      tau1=30,
      tau2=10,
      tau_m=15),
    splSupRoo1(dp_nominal={0,-120,0}),
    splSupSou(dp_nominal={0,-120,0}),
    splSupEas(dp_nominal={0,-120,0}),
    splSupNor(dp_nominal={0,-120,0}),
    gaiCooCoi(k=m_flow_nominal*1000*15/4200/10),
    gaiHeaCoi(k=m_flow_nominal*1000*40/4200/10));
  ...
  Buildings.Controls.OBC.CDL.Discrete.Sampler sampler(samplePeriod=120)
    "Sample number of requests"
    annotation (Placement(transformation(extent={{266,-10},{246,10}})));
equation
  ...
  connect(freBas.y, fanSup.f_in) annotation (Line(points={{361,0},{356,0},
          {356,-20},{302,-20},{302,-28}},color={0,0,127}));
  connect(dpDisSupFan.p_rel, sampler.u)
    annotation (Line(points={{311,0},{268,0}}, color={0,0,127}));
  connect(sampler.y, conAHU.ducStaPre) annotation (Line(points={{245,0},{160,0},
          {160,406},{383,406}}, color={0,0,127}));
  annotation (
