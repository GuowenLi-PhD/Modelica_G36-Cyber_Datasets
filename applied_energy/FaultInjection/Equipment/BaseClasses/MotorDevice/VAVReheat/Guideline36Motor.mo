...
public
  ...
  Modelica.Blocks.Continuous.Filter filter(f_cut=1/20)
    annotation (Placement(transformation(extent={{370,60},{390,80}})));
  Modelica.ComplexBlocks.Sources.ComplexConstant a(k(re=cos(0), im=sin(0)))
    annotation (Placement(transformation(extent={{260,-118},{280,-98}})));
  Modelica.ComplexBlocks.Sources.ComplexConstant b(k(re=cos(-2/3*pi), im=sin(-2/
          3*pi)))
    annotation (Placement(transformation(extent={{260,-158},{280,-138}})));
  Modelica.ComplexBlocks.Sources.ComplexConstant c(k(re=cos(2/3*pi), im=sin(2/3*
          pi)))
    annotation (Placement(transformation(extent={{260,-198},{280,-178}})));
  Modelica.ComplexBlocks.ComplexMath.ComplexToReal complexToReal1
    annotation (Placement(transformation(extent={{300,-118},{320,-98}})));
  Modelica.ComplexBlocks.ComplexMath.ComplexToReal complexToReal2
    annotation (Placement(transformation(extent={{300,-158},{320,-138}})));
...
equation
  ...
  connect(pro3[2].y, fanSup.Vcs[1, 2]) annotation (Line(points={{381,-190},{404,
          -190},{404,-64},{272,-64},{272,-42},{298,-42}}, color={0,0,127}));
  connect(conAHU.ySupFan, b2r.u) annotation (Line(points={{425,450},{466,450},{466,
          226},{300,226},{300,70},{318,70}}, color={255,0,255}));
  connect(b2r.y, filter.u)
    annotation (Line(points={{341,70},{368,70}}, color={0,0,127}));
  connect(filter.y, pro1[1].u1) annotation (Line(points={{391,70},{400,70},{400,
          44},{266,44},{266,-70},{352,-70},{352,-104},{358,-104}}, color={0,0,
          127}));
  connect(filter.y, pro1[2].u1) annotation (Line(points={{391,70},{400,70},{400,
          44},{266,44},{266,-70},{352,-70},{352,-104},{358,-104}}, color={0,0,
          127}));
  connect(filter.y, pro2[1].u1) annotation (Line(points={{391,70},{400,70},{400,
          44},{266,44},{266,-70},{352,-70},{352,-144},{358,-144}}, color={0,0,
          127}));
  connect(filter.y, pro2[2].u1) annotation (Line(points={{391,70},{400,70},{400,
          44},{266,44},{266,-70},{352,-70},{352,-144},{358,-144}}, color={0,0,
          127}));
  connect(filter.y, pro3[1].u1) annotation (Line(points={{391,70},{400,70},{400,
          44},{266,44},{266,-70},{352,-70},{352,-184},{358,-184}}, color={0,0,
          127}));
  connect(filter.y, pro3[2].u1) annotation (Line(points={{391,70},{400,70},{400,
          44},{266,44},{266,-70},{352,-70},{352,-184},{358,-184}}, color={0,0,
          127}));
  connect(a.y, complexToReal1.u)
    annotation (Line(points={{281,-108},{298,-108}}, color={85,170,255}));
  connect(b.y, complexToReal2.u)
    annotation (Line(points={{281,-148},{298,-148}}, color={85,170,255}));
  connect(c.y, complexToReal3.u)
    annotation (Line(points={{281,-188},{298,-188}}, color={85,170,255}));
  connect(complexToReal1.re, pro1[1].u2) annotation (Line(points={{322,-102},{340,
          -102},{340,-116},{358,-116}},     color={0,0,127}));
  connect(complexToReal1.im, pro1[2].u2)
    annotation (Line(points={{322,-114},{340,-114},{340,-116},{358,-116}},
                                                     color={0,0,127}));
  connect(complexToReal2.re, pro2[1].u2) annotation (Line(points={{322,-142},{340,
          -142},{340,-156},{358,-156}},     color={0,0,127}));
  connect(complexToReal2.im, pro2[2].u2)
    annotation (Line(points={{322,-154},{340,-154},{340,-156},{358,-156}},
                                                     color={0,0,127}));
  connect(complexToReal3.re, pro3[1].u2) annotation (Line(points={{322,-182},{340,
          -182},{340,-196},{358,-196}},     color={0,0,127}));
  connect(complexToReal3.im, pro3[2].u2)
    annotation (Line(points={{322,-194},{340,-194},{340,-196},{358,-196}},
                                                     color={0,0,127}));
  annotation (
