...
model Guideline36MotorExport_test
...
public
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant yFreHeaCoi1(final k=1)
    "Flow rate signal for heating coil when freeze stat is on"
...
equation
  ...
  connect(complexToReal3.im, pro3[2].u2) annotation (Line(points={{518,-256},{
          ...
          127}));
  connect(yFreHeaCoi1.y, pro4.u2) annotation (Line(points={{201,-310},{250,-310},
          {250,-96},{258,-96}}, color={0,0,127}));
...
end Guideline36MotorExport_test;
