...
model SimpleElectricPumpVoltageCompare
  ...
  Modelica.Blocks.Sources.Step volUp(
    height=10,
    startTime(displayUnit="min") = 900,
    offset=120)
  ...
  Modelica.Blocks.Sources.RealExpression spe(y=1474.6)
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    __Dymola_Commands(file=
        ...
        "Simulate and Plot"));
end SimpleElectricPumpVoltageCompare;
