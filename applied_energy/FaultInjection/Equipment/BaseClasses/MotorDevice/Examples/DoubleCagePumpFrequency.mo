...
equation
  ...
  connect(pro2.y, pum2.Vbs[1, :]) annotation (Line(points={{-99,-40},{-88,
          -40},{-88,-2},{2,-2},{2,-38},{8,-38}},
                                           color={0,0,127}));
  connect(pro3.y, pum2.Vcs[1, :]) annotation (Line(points={{-99,-80},{-86,
          -80},{-86,-4},{4,-4},{4,-42},{8,-42}},
                                           color={0,0,127}));
  annotation (Diagram(
