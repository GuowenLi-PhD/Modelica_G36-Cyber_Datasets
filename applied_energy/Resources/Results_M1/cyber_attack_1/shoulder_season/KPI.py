...
startTime = 83*24*3600. # start from day 83
...
plt.ylim([4,16])
plt.legend(['Baseline ','Attack'])
plt.xticks(np.arange(startTime,endTime+1,4*3600), np.arange(0,24+1,4).tolist())
plt.xlabel('Hours')
...
print("TCorNotmet_base: ",TCorNotmet_base)
...
print("powDem_attack: ",powDem_attack)
# zone temperature notmet hours
startOCC = 6*3600
endOCC = 19*3600
...
print("TCorNotmet_attack: ",TCorNotmet_attack)
